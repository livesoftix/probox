...
return new class extends Migration
{
    ...
    {
        Schema::create('wage_manual_pasting_dcs', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('manualpasting_wage', 15, 2)->default(0);
    ...
    {
        Schema::dropIfExists('wage_manual_pasting_dcs');
    }
};