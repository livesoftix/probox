...
<div class="leftside-menu">
    ...
    <a href="index.html" class="logo logo-light">
        <span class="logo-lg">
            <img src="{{ asset('probox/public/assets/images/logo.png') }}" alt="logo">
        </span>
        <span class="logo-sm">
            <img src="{{ asset('probox/public/assets/images/logo-sm.png') }}" alt="small logo">
        </span>
    </a>
    ...
    <a href="index.html" class="logo logo-dark">
        <span class="logo-lg">
            <img src="{{ asset('probox/public/assets/images/logo-dark.png') }}" alt="dark logo">
        </span>
        <span class="logo-sm">
            <img src="{{ asset('probox/public/assets/images/logo-dark-sm.png') }}" alt="small logo">
        </span>
    </a>
                ...
                <div class="collapse" id="sidebarLayouts">
                    <ul class="side-nav-second-level">
                        ...
                        <li>
                         ...
                         <li>
                            <a href="{{ route('office_cash.reports') }}">Office Cash</a>
                        </li>
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarEmails2">
                    <ul class="side-nav-second-level">
                        ...
                        <!--<li>-->
                        <!--    <a href="{{ route('stock_report.reports') }}">Stock Reports</a>-->
                        <!--</li>-->
                        <li>
...
<li class="side-nav-item">
    ...
    <div class="collapse" id="sidebarWages">
        <ul class="side-nav-second-level">
            <li>
                <a href="{{ route('corrugation_wage_dc.report') }}">
                    Corrugation
                </a>
            </li>
            <li>
                <a href="{{ route('manualPasting_wage_dc.report') }}">
                    Manual Pasting
                </a>
            </li>
             <li>
                <a href="{{ route('autoPasting_wage_dc.report') }}">
                    Auto Pasting
                </a>
            </li>
             <li>
                <a href="{{ route('breaking_wage_dc.report') }}">
                    Breaking
                </a>
            </li>
        </ul>
             ...
             <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarEmails26">
                    <ul class="side-nav-second-level">
                        <li>
                            <a href="{{ route('boxboard_wage.report') }}">Boxboard Cutting Dept</a>
                        </li>
             ...
             <li class="side-nav-item">
                <a href="{{ route('salary_calc.list') }}" class="side-nav-link">
...
<li class="side-nav-item">
             ...
             <li>
                            <a href="{{ route('wastage_sale.reports') }}">Wastage Sale</a>
                        </li>

 <li>
                            <a href="{{ route('wastage.reports') }}">Wastage Sale Reports</a>
                        </li>
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarEmai333">
                    <ul class="side-nav-second-level">
                         <li>
                            <a href="{{ route('purchase_return.reports') }}">Boxboard Return</a>
                        </li>
                      
                        <li>
                            <a href="{{ route('plate_return.reports') }}">Plate Return</a>
                        </li>
                        <li>
                            <a href="{{ route('glue_return.reports') }}">Glue Return</a>
                        </li>
                        <li>
                            <a href="{{ route('ink_return.reports') }}">Ink Return</a>
                        </li>
                        <li>
                            <a href="{{ route('lamination_return.reports') }}">Lamination Return</a>
                        </li>
                        <li>
                            <a href="{{ route('corrugation_return.reports') }}">Corrugation Return</a>
                        </li>
                        <li>
                            <a href="{{ route('shipper_return.reports') }}">Shipper Return</a>
                        </li>
                         <li>
                            <a href="{{ route('dye_return.reports') }}">Dye Return</a>
                        </li>
...
<li class="side-nav-item">
            ...
            <li class="side-nav-item">
                <a href="{{route('create_account.reports')}}" class="side-nav-link">
                    <i class="uil-user"></i>
            ...
            <li class="side-nav-item">
                <a href="{{ route('admin.backup') }}" class="side-nav-link">
