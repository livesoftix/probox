                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <form action="{{route('party.store')}}" method="POST">
                                        ...
                                        <div class="mb-3">
                                            <label for="example-email" class="form-label">Balance</label>
                                            <input type="text" id="example-email" class="form-control" placeholder="Balance" name="balance">
                                        </div>



                                        <div class="mb-3">
                                            <label for="example-disable" class="form-label">Party registration</label>
                                            <select name="registered" id="" class="form-control">
