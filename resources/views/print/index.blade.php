...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            @endif
            <div class="col-12">
                <a href="{{ route('print.list') }}"><button type="button" class="btn btn-primary" onclick="return checkPermission()">Add
                        Department</button></a>
                                    ...
                                    <tbody>
                                        @foreach ($printSections as $print)
                                            <tr>
                                                ...
                                                <td>{{ $print->name }}</td>
                                                <td class="no-print">
                                                    <form action="{{ route('print.destroy', $print->id) }}" method="POST" style="display: inline;" onclick="return confirm('Are you sure you want to delete this item?')">
            @csrf
            @method('DELETE')
            <button type="submit" class="btn btn-danger" style="margin-left: 2px;"   onclick="return checkPermissionDel()" >Delete</button>
        </form>
        
         <a href="{{ route('print.edit', $print->id) }}" class="btn btn-warning  " onclick="return checkPermissionEdit()">Edit</a>
