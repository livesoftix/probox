...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Bonus Type</h4>
                </div>
            </div>
        ...
        <div class="row">
            ...
            @endif
            <div class="col-12">
                <a href="{{ route('extra_time.list') }}"><button type="button" class="btn btn-primary" onclick="return checkPermission()">Add
                        New</button></a>
                                    ...
                                    <tbody>
                                        @foreach ($printSections as $print)
                                            <tr>
                                                ...
                                                <td>{{ $print->rate }}</td>
                                                <td class="no-print">
                                                 <form action="{{ route('extra_time.destroy', $print->id) }}" method="POST" style="display: inline;" onclick="return confirm('Are you sure you want to delete this item?')">
    @csrf
    @method('DELETE')
    <button type="submit" class="btn btn-danger" style="margin-left: 2px;"   onclick="return checkPermissionDel()">Delete</button>
</form>
        
         <a href="{{ route('extra_time.edit', $print->id) }}" class="btn btn-warning  " onclick="return checkPermissionEdit()">Edit</a>
