                            ...
                            <div class="tab-content">
                                <div class="col-12">
                                                ...
                                                @if (count($uniqueItemTitles) > 0)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @if ($billingNo)
                                                                <form
                                                                    action="{{ route('confect_billing.destroy', ['billing_no' => $billingNo]) }}"
                                    ...
                                    <table id="combined-data-table-2"
                                        ...
                                        @if ($accountTitles)
                                            <h2 id="print-header2" style="display: none;">Name: {{ $accountTitles }}</h2>
                                        @endif
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($filteredInvoices as $index => $data)
                                                ...
                                                @if ($rateMissing || $amountMissing)
                                                    <script>
                                                        alert('Warning: Rate or Amount is missing for Invoice #: {{ $data->v_no }}');
                                                    </script>
                                                @endif
                                                ...
                                                @if ($acc !== 'N/A' && $gt !== 'N/A')
                                                    ...
                                                    <tr class="default-row">
                                                        ...
                                                        <td>{{ isset($data->rate) ? number_format((float) $data->rate, 2) : 'N/A' }}
                                                        </td>
                                                ...
                                                @if ($gt !== 'N/A' && ($isLast || $nextVNoDifferent))
                                                    ...
                                                    {{-- <tr class="official-row" style="display: none;">
                                                        ...
                                                        <td style="font-weight: bold;">{{ number_format($gt, 2) }}</td>

                                                    </tr>
                                                    <tr class="official-row" style="display: none;">
                                                        <td colspan="6" style="text-align: right; font-weight: bold;">
                                                            Grand Total Sales Tax:</td>
                                                        <td style="font-weight: bold;">
                                                            {{ number_format($grandSalesTaxByVNo[$data->v_no] ?? 0, 2) }}
                                                        </td>
                                                    ...
                                                    <tr class="official-row" style="display: none;">
                                                        ...
                                                        <td style="font-weight: bold;">
                                                            {{ number_format($grandValueWithTaxByVNo[$data->v_no] ?? 0, 2) }}
                                                        </td>
