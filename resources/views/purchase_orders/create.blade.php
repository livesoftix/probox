                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select name="machine_size" class="po-select" required>
                        ...
                        @foreach([
                            ...
                            <option value="{{ $machineSize }}" {{ old('machine_size') == $machineSize ? 'selected' : '' }}>
                                {{ $machineSize }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="items-section">
                ...
                <div id="itemsBody">
                    <div class="po-item-row item-row">
                        <div class="row-number font-weight-bold">1</div>
                        <div>
                            <input type="text"
                        ...
                        <div class="text-center">
                            <button type="button" class="remove-item-btn remove-item" disabled title="Remove item">
                ...
                <div class="items-total-bar">
                    ...
                    <input type="text" id="totalQuantity" class="items-total-input" value="1" readonly>
                </div>
            </div>
