...
@section('content')
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Country Registration</h4>
                </div>
            </div>
        ...
        <div class="row">
            ...
            @endif
            <div class="col-12">
                <a href="{{ route('country.list') }}"><button type="button" class="btn btn-primary" onclick="return checkPermission()">Add
                        Country</button></a>
                <button type="button" class="btn btn-secondary" onclick="printTable()">Print Table</button>
                <!-- Print Button -->
                <div class="card mt-2">
                    <div class="card-body">
                        <h4 class="header-title">Countries Name</h4>
                                    ...
                                    <tbody>
                                        @foreach ($countries as $country)
                                            <tr>
                                                ...
                                                <td class="no-print"><form action="{{ route('country.destroy', $country->id) }}" method="POST" style="display: inline;">
            @csrf
            @method('DELETE')
     ...
     function checkPermission() {
        ...
        if ($isAdmin == 0) {
            $userRights = \App\Models\Right::where('user_id', auth()->user()->id)
                ->where('app_name', 'CountryRegistration')
                ->first();
