    ...
    <div class="card mt-2">
      <div class="card-body">
        ...
        <div class="tab-content">
          <div class="col-6">
            <form action="{{ route('ink_return.reports') }}" method="GET" class="form-inline" id="search-form">
              <div class="row">
                ...
                <div class="form-group mt-3">
                  ...
                  <a class="btn btn-success" href="{{ route('ink_return.list') }}" role="button"
                ...
                <table id="combined-data-table" class="table table-striped dt-responsive nowrap w-100">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $data->inkreturns->items->item_code ?? 'N/A'}}</td>
                      <td>{{ $data->inkreturns->qty ?? 'N/A'}}</td>
                      <td>{{ $data->inkreturns->rate ?? 'N/A'}}</td>
                      <td>{{ $data->inkreturns->amount ?? 'N/A'}}</td>
                      <td class="no-print">
                        ...
                        <td class="no-print">
            @if($data->inkreturns) <!-- Check if plate return exists -->
            <form action="{{ route('ink_return.destroy', $data->inkreturns->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this record?');">
                @csrf
                @method('DELETE')
