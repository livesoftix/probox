  ...
  <div class="row">
    <div class="col-12">
      <div class="page-title-box">
        ...
        <h4 class="page-title">Ink Return</h4>
      </div>
    </div>
  </div>
  <!-- End page title -->
        ...
        <div class="card-body">
          <div class="tab-content">
            <div class="tab-pane show active" id="input-types-preview">
              <div class="row">
                <form id="voucherForm" action="{{ route('ink_return.store') }}" method="POST">
                  @csrf
                  <div class="col-6">
                    ...
                    <input type="hidden" id="invoice_type" class="form-control" name="v_type" value="IPN" required readonly>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" id="preparedBy" class="form-control" value="{{ $loggedInUser->name }}"
                        name="prepared_by" readonly>
                    </div>

                    <div class="mb-3">
                      <label for="entryParty" class="form-label">Supplier</label>
                      <select name="account" class="form-control select2" data-toggle="select2" id="entryParty"
                        required>
                        <option value="">Select</option>
                        @foreach ($accountSuppliers->whereIn('level2_id', [4, 23]) as $accountSupplier)
                        <option value="{{ $accountSupplier->id }}">
                          {{ $accountSupplier->title }}
                        </option>
                        @endforeach
                      </select>
                    </div>
