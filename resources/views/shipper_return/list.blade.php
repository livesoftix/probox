  ...
  <div class="row">
    <div class="col-12">
      <div class="page-title-box">
        ...
        <h4 class="page-title">Shipper Return</h4>
      </div>
    </div>
  </div>
  <!-- End page title -->
        ...
        <div class="card-body">
          <div class="tab-content">
            <div class="tab-pane show active" id="input-types-preview">
              <div class="row">
                <form id="voucherForm" action="{{ route('shipper_return.store') }}" method="POST">
                  @csrf
                  <div class="col-6">
                    ...
                    <input type="hidden" id="invoice_type" class="form-control" name="v_type" value="SPN" required readonly>
