    ...
    <div class="card mt-2">
      <div class="card-body">
        ...
        <div class="tab-content">
          <div class="col-6">
            <form action="{{ route('shipper_return.reports') }}" method="GET" class="form-inline" id="search-form">
              <div class="row">
                ...
                <div class="form-group mt-3">
                  ...
                  <a class="btn btn-success" href="{{ route('shipper_return.list') }}" role="button"
                ...
                <table id="combined-data-table" class="table table-striped dt-responsive nowrap w-100">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{ $data->shipperreturns->items->item_code ?? 'N/A'}}</td>
                      <td>{{ $data->shipperreturns->qty ?? 'N/A'}}</td>
                      <td>{{ $data->shipperreturns->rate ?? 'N/A'}}</td>
                      <td>{{ $data->shipperreturns->amount ?? 'N/A'}}</td>
                      <td class="no-print">
                      ...
                      <td class="no-print">
                        @if($data->shipperreturns) 
                        <form action="{{ route('shipper_return.destroy', $data->shipperreturns->id) }}" method="POST"
