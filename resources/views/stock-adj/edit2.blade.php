                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="input-types-preview">
                            <div class="row">
                                <form id="voucherForm" action="{{ route('stock-adj.update', $voucher->first()->v_no) }}"
                                    method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="col-6">
                                        ...
                                        <table class="table mt-4" id="entriesTable">
                                            ...
                                            <tbody id="entriesBody">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!-- Delete Entry Button -->
                                                        <a href="{{ route('stock-adj.destroy', $trndtl->v_no) }}"
                                                            class="btn btn-danger btn-sm"
                                                            onclick="event.preventDefault();
                                                                            if(confirm('Are you sure you want to delete this transaction?')) {
                                                                                window.location.href='{{ route('stock-adj.destroy', $trndtl->v_no) }}';
                                                                            }">Delete</a>
                                                    </td>
                                                </tr>
                                                @endforeach
