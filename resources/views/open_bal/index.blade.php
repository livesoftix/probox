    ...
    <div class="card">
        <div class="card-body">
            <div class="tab-content">
                <div class="col-12">
                    <form action="{{ route('open_bal.reports') }}" method="GET" id="search-form">
                        <div class="row g-2 align-items-end">
                            ...
                            <div class="col-md-12 d-flex gap-2">
                                ...
                                <a class="btn btn-success" href="{{ route('open_bal.list') }}"
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($trndtls as $trndtl)
                                                <tr>
                                                    ...
                                                    <td class="no-print">
                                                        <!-- Edit button -->
                                                        <a href="{{ route('open_bal.edit', $trndtl->v_no) }}"
                                                            class="btn btn-warning btn-sm"
                                                            onclick="return checkPermissionEdit()">Edit</a>

                                                        <!-- Delete button (use form for method spoofing) -->
                                                        <form action="{{ route('open_bal.destroy', $trndtl->v_no) }}"
                                                            method="POST" style="display:inline-block;"
                                                            onclick="return checkPermissionDel()">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit" class="btn btn-danger btn-sm"
                                                                onclick="return confirm('Are you sure you want to delete the entire voucher OB-{{ $trndtl->v_no }}?')">
                                                                Delete Voucher
                                                            </button>
                                                        </form>
