            ...
            <div class="page-title-box">
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Auto Pasting Wage DC Department</li>
                    </ol>
                </div>
                <h3 class="page-title">Auto Pasting Delivery Challan Department</h3>
            </div>
        </div>
    </div>
    <!-- end page title -->
                        ...
                        <div class="tab-content">
                            <div class="col-12">
                                <table id="combined-data-table" class="table table-striped dt-responsive nowrap w-100">
                                    <h3>Auto Pasting Department Details</h3>
                                    <thead>
                                        <tr>
                                            <th>Date</th>
    ...
    @foreach ($WageAutoPastings as $general)
        @php
            ...
            $processedEntries[] = $entryKey;
                        $depcontractor = \App\Models\EmployeeType::where('department_id', 19)
  ...
  function checkPermission() {
        ...
        if ($isAdmin == 0) {
            $userRights = \App\Models\Right::where('user_id', auth()->user()->id)
                ->where('app_name', 'autoPastingwages')
                ->first();
