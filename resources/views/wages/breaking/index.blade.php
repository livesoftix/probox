        ...
        <div class="card mt-2">
            <div class="card-body">
                <div class="tab-content">
                    <div class="col-12">
                        <form action="{{ route('breaking_wage_dc.report') }}" method="GET" class="form-inline" id="search-form">
     <div class="row">
...
{{ $employee->lname }}
    ...
    <div class="form-group mt-3">
        ...
        <a href="{{ route('breaking_wage_dc.list') }}"
    ...
    @foreach ($WageBreakings as $general)
        @php
...
<td class="no-print">
    ...
    <a href="{{ route('breaking_wage_dc.edit', $general->b_no) }}"
       class="btn btn-warning btn-sm">
        Edit
    </a>


    <a href="{{ route('breaking_wage_dc.print', $general->b_no) }}"
       target="_blank"
    ...
    <form action="{{ route('breaking_wage_dc.destroy', $general->id) }}"
          method="POST"
