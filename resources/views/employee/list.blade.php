...
{{-- @include('components.head') --}}
        ...
        <div class="row">
            ...
            <div class="col-12">
                <a href="{{ route('employee.create') }}"><button type="button" class="btn btn-primary">Add
                        Employee</button></a>
                                    ...
                                    <tbody>
                                        @foreach ($employees as $employee)
                                            <tr>
                                                ...
                                                <td>{{ \Carbon\Carbon::parse($employee->shift_time1)->format('g:i A') }}</td>
                                                <td>{{ \Carbon\Carbon::parse($employee->shift_time2)->format('g:i A') }}</td>
