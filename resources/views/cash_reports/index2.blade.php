    ...
    <div class="card">
        <div class="card-body">
            <div class="tab-content">
                <div class="col-12">
                    <form action="{{ route('payment.reports') }}" method="GET" id="search-form">
                        <div class="row g-2 align-items-end">
                            ...
                            <div class="col-md-4 d-flex gap-2">
                                ...
                                <a class="btn btn-success" href="{{ route('payment.list') }}" onclick="return checkPermission()">
                                    Add New
                                </a>
                            </div>
                                            ...
                                            @foreach ($trndtls as $trndtl)
                                                <tr>
                                                    ...
                                                    <td class="no-print">
                                                        ...
                                                        <form action="{{ route('payment.delete', $trndtl->id) }}"
