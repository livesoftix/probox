            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="col-12">
                            <form action="{{ route('cash.reports') }}" method="GET" id="search-form">
                                <div class="row g-2 align-items-end"> {{-- g-2 = spacing between columns --}}
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <select name="account_id" class="form-control select2" data-toggle="select2">
                                            ...
                                            @foreach ($accountIdList as $id)
                                                ...
                                                @endphp
                                                <option value="{{ $id }}"
                                                    {{ request()->get('account_id') == $id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-4 d-flex gap-2">
                                        ...
                                        <a class="btn btn-success" href="{{ route('cash.list') }}"
