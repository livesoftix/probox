...
@section('content')
    <div class="container-fluid">
        ...
        @endif
            <div class="col-12">
                <a
                        href="{{ route('inventory.create.itemtype') }}"><button type="button" class="btn btn-primary" onclick="return checkPermission()" >Add Item</button></a>
                                ...
                                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        @foreach ($itemtypes as $itemtype)
                                            <tr>
                                                <td>{{ $itemtype->id }}</td>
                                                <td>{{ $itemtype->type_title }}</td>
                                                <td class="no-print">
                                                    <div class="d-flex">
                                                    <a href="{{ route('inventory.itemtype.edit', $itemtype->id) }}">
                                                    ...
                                                    <form action="{{ route('inventory.itemtype.destroy', $itemtype->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this Item Type?');">
                                                        @csrf
                                                        @method('DELETE')
