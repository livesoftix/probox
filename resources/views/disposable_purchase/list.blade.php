    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form id="voucherForm" action="{{ route('disposable_purchase.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" id="date" name="date" class="form-control" value="{{ old('date', \Carbon\Carbon::now()->toDateString()) }}">
                                    </div>

                                    <div class="mb-3">
                                        <label for="preparedBy" class="form-label">Prepared By</label>
                                        <input type="text" id="preparedBy" class="form-control" value="{{ $loggedInUser->name ?? auth()->user()->name ?? '' }}" name="prepared_by" readonly>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select id="item_id" class="form-control select2" data-toggle="select2">
                                            ...
                                            @foreach ($items as $item)
                                                <option value="{{ $item->id }}" data-rate="{{ $item->purchase ?? $item->rate ?? 0 }}">{{ $item->item_code }}</option>
                                            @endforeach
                                        </select>
                                    </div>
