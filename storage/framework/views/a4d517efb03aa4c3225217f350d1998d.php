        ...
        <div class="card mt-2">
            <div class="card-body">
                <div class="tab-content">
                    <div class="col-12">
                        <form action="<?php echo e(route('purchase.reports')); ?>" method="GET" class="form-inline"
                            id="search-form">
                            <div class="row">
                                <!-- Start Date -->
                                ...
                                <div class="form-group col-xl-2">
                                    ...
                                    <select name="account" class="form-control select2" id="account"
                                        ...
                                        <option value="<?php echo e($product->account_id); ?>" <?php echo e(request()->get('account') ==
                                            $product->account_id ? 'selected' : ''); ?>>
                                            <?php echo e($product->accounts->title ?? 'Select a Party'); ?>
                            ...
                            <div class="col-12">
                                ...
                                <table id="combined-data-table-boxboard" class="table dt-responsive nowrap w-100 small-font-table ">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $groupedData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($row['date']); ?></td>
                                            <td><?php echo e($row['v_no']); ?></td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td><strong><?php echo e(number_format($grandTotal1, 2)); ?></strong></td>
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <table id="combined-data-table-return" class="table dt-responsive nowrap w-100 small-font-table ">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $trndtl1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        $key = $data->date . '_' . $data->v_type . '-' . $data->v_no;
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="2" style="text-align:right;"><strong>Total</strong></td>
                                            <td><strong><?php echo e(number_format($grandTotal2, 2)); ?></strong></td>
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <table id="combined-data-table-plate" class="table dt-responsive nowrap w-100 small-font-table ">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $trndtl2; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        $key = $data->date . '_' . $data->v_type . '-' . $data->v_no;
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="2" style="text-align:right;"><strong>Total</strong></td>
                                            <td><strong><?php echo e(number_format($grandTotal3, 2)); ?></strong></td>
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <table id="combined-data-table-glue" class="table dt-responsive nowrap w-100 small-font-table ">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $trndtl3; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        $key = $data->date . '_' . $data->v_type . '-' . $data->v_no;
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="2" style="text-align:right;"><strong>Total</strong></td>
                                            <td><strong><?php echo e(number_format($grandTotal4, 2)); ?></strong></td>
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <table id="combined-data-table-ink" class="table dt-responsive nowrap w-100 small-font-table ">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $trndtl4; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        $key = $data->date . '_' . $data->v_type . '-' . $data->v_no;
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="2" style="text-align:right;"><strong>Total</strong></td>
                                            <td><strong><?php echo e(number_format($grandTotal5, 2)); ?></strong></td>
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <table id="combined-data-table-lamination" class="table dt-responsive nowrap w-100 small-font-table ">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $trndtl5; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        $key = $data->date . '_' . $data->v_type . '-' . $data->v_no;
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="2" style="text-align:right;"><strong>Total</strong></td>
                                            <td><strong><?php echo e(number_format($grandTotal6, 2)); ?></strong></td>
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <table id="combined-data-table-corrugation" class="table dt-responsive nowrap w-100 small-font-table ">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $trndtl6; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        $key = $data->date . '_' . $data->v_type . '-' . $data->v_no;
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="2" style="text-align:right;"><strong>Total</strong></td>
                                            <td><strong><?php echo e(number_format($grandTotal7, 2)); ?></strong></td>
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <table id="combined-data-table-shipper" class="table dt-responsive nowrap w-100 small-font-table ">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $trndtl7; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        $key = $data->date . '_' . $data->v_type . '-' . $data->v_no;
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="2" style="text-align:right;"><strong>Total</strong></td>
                                            <td><strong><?php echo e(number_format($grandTotal8, 2)); ?></strong></td>
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <table id="combined-data-table-dye" class="table dt-responsive nowrap w-100 small-font-table ">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $trndtl8; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php
                                        $key = $data->date . '_' . $data->v_type . '-' . $data->v_no;
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="2" style="text-align:right;"><strong>Total</strong></td>
                                            <td><strong><?php echo e(number_format($grandTotal9, 2)); ?></strong></td>
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <h4 style="text-align:right; ">Grand Total: <strong><?php echo e(number_format($totalGrandTotal,
                                        2)); ?></strong></h4>
                                

                                <!-- New Data Start from here -->

                                <?php elseif($productType == 'PIN'): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/reports/index.blade.php ENDPATH**/ ?>