            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="col-12">
                            <form action="<?php echo e(route('cash.reports')); ?>" method="GET" id="search-form">
                                <div class="row g-2 align-items-end"> 
                                        ...
                                        <select name="account_id" class="form-control select2" data-toggle="select2">
                                            ...
                                            <?php $__currentLoopData = $accountIdList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <option value="<?php echo e($id); ?>"
                                                    <?php echo e(request()->get('account_id') == $id ? 'selected' : ''); ?>>
                                    ...
                                    <div class="col-md-4 d-flex gap-2">
                                        ...
                                        <a class="btn btn-success" href="<?php echo e(route('cash.list')); ?>"
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $trndtls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trndtl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td class="no-print">
                                                    <!-- Edit button -->
                                                    <a href="<?php echo e(route('cash.edit', $trndtl->v_no)); ?>"
                                                        class="btn btn-warning btn-sm"
                                                        onclick="return checkPermissionEdit()">Edit</a>

                                                    <!-- Delete button (use form for method spoofing) -->
                                                    <form action="<?php echo e(route('cash.delete', $trndtl->id)); ?>" method="POST"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/cash_reports/index.blade.php ENDPATH**/ ?>