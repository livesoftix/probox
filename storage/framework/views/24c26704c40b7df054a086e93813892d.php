    ...
    <div class="card">
        <div class="card-body">
            <div class="tab-content">
                <div class="col-12">
                    <form action="<?php echo e(route('journal_voucher.reports')); ?>" method="GET" id="search-form">
                        <div class="row g-2 align-items-end">
                            ...
                            <div class="col-md-12 d-flex gap-2">
                                ...
                                <a class="btn btn-success" href="<?php echo e(route('journal_voucher.list')); ?>"
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $trndtls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trndtl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($trndtl->credit); ?></td>
                                                    ...
                                                    <td class="no-print">
                                                        <!-- Edit button -->
                                                        <a href="<?php echo e(route('journal_voucher.edit', $trndtl->v_no)); ?>"
                                                            class="btn btn-warning btn-sm"
                                                            onclick="return checkPermissionEdit()">Edit</a>

                                                        <!-- Delete button (use form for method spoofing) -->
                                                        <form
                                                            action="<?php echo e(route('journal_voucher.destroy', $trndtl->v_no)); ?>"
                                                            method="POST" style="display:inline-block;"
                                                            onclick="return checkPermissionDel()">
                                                            <?php echo csrf_field(); ?>
                                                            <?php echo method_field('DELETE'); ?>
                                                            <button type="submit" class="btn btn-danger btn-sm"
                                                                onclick="return confirm('Are you sure you want to delete the entire voucher JV-<?php echo e($trndtl->v_no); ?>?')">
                                                                Delete Voucher
                                                            </button>
                                                        </form>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/journal_voucher_reports/index.blade.php ENDPATH**/ ?>