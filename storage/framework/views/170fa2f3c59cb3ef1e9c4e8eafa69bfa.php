                                        ...
                                        <?php $__currentLoopData = $trnDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div
                                                ...
                                                <h3 id="print-header1" style="margin: 0; display: none;">
                                                    Date:
                                                    <?php echo e(\Carbon\Carbon::parse($data1->date)->format('d-m-Y') ?? 'N/A'); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/sale_reports/index7.blade.php ENDPATH**/ ?>