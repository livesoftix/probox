...
<?php endif; ?>
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form id="voucherForm" action="<?php echo e(route('employee_type.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="col-6">
        ...
        <select name="cnic_no" id="cnic_no" class="form-control select2" data-toggle="select2" required>
            ...
            <option value="<?php echo e($employee->id); ?>" <?php echo e(old('id')==$employee->id ? 'selected' : ''); ?>>
   ...
   <div class="col-md-6 mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="salary_type" class="form-control" id="salary_type">
                                <option value="">Select</option>
                                <option value="salary" <?php echo e(old('salary_type')=='salary' ? 'selected' : ''); ?>>Salary</option>
                                <option value="waje" <?php echo e(old('salary_type')=='waje' ? 'selected' : ''); ?>>Wage</option>
                            </select>
                        </div>
                        ...
                        <div id="salary_section" style="display: none;">
                            <div class="mb-3">
                                ...
                                <input type="number" id="salary_amount" class="form-control" name="salary_amount" step="any" value="<?php echo e(old('salary_amount')); ?>">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="time" id="shift_from" class="form-control" name="shift_from" value="<?php echo e(old('shift_from')); ?>">
                                    </div>
                                    <div class="col-6">
                                        <label for="shift_to" class="form-label">To</label>
                                        <input type="time" id="shift_to" class="form-control" name="shift_to" value="<?php echo e(old('shift_to')); ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="time" id="break_from" class="form-control" name="break_from" value="<?php echo e(old('break_from')); ?>">
                                    </div>
                                    <div class="col-6">
                                        <label for="break_to" class="form-label">To</label>
                                        <input type="time" id="break_to" class="form-control" name="break_to" value="<?php echo e(old('break_to')); ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="waje_section_solna" style="display: none;">
                            <div class="mb-3">
                                ...
                                <input type="number" id="basic_salary" class="form-control" name="basic_salary" step="any" value="<?php echo e(old('basic_salary')); ?>">
                            </div>
                            
                            <div class="mb-3">
                                <label for="fix_impression_day" class="form-label">Fix Impression per Day</label>
                                <input type="number" id="fix_impression_day" class="form-control" name="fix_impression_day" step="any" value="<?php echo e(old('fix_impression_day')); ?>">
                            </div>
                            
                            <div class="mb-3">
                                <label for="lam_working_days" class="form-label">Working day in a Month</label>
                                <input type="number" id="lam_working_days" class="form-control" name="lam_working_days" step="any" value="<?php echo e(old('lam_working_days')); ?>">
                            </div>

                            <div class="mb-3">
                                <label for="over_time" class="form-label">Over Time salary per Month</label>
                                <input type="number" id="over_time" class="form-control" name="over_time" step="any" value="<?php echo e(old('over_time')); ?>">
                            </div>
                        </div>
                ...
                <div class="col-md-2">
                    <button type="button" class="btn btn-primary add-process">+</button>
                        ...
                        <div class="mb-3" id="per_sheet_rate_container" style="display: none;">
                            ...
                            <input type="number" id="per_sheet_rate" class="form-control" name="per_sheet_rate" step="any" value="<?php echo e(old('per_sheet_rate')); ?>">
                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/employee_type/list.blade.php ENDPATH**/ ?>