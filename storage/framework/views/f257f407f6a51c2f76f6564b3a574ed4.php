                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img src="<?php echo e(asset('probox/public/assets/images/users/avatar-2.jpg')); ?>" class="img-fluid rounded-circle" alt="" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 text-truncate ms-2">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item p-0 notify-item card read-noti shadow-none mb-2">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <div class="notify-icon">
                                            <img src="<?php echo e(asset('probox/public/assets/images/users/avatar-4.jpg')); ?>" class="img-fluid rounded-circle" alt="" />
                                        </div>
                                    </div>
                                    <div class="flex-grow-1 text-truncate ms-2">
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <span class="account-user-avatar">
                        <img src="<?php echo e(asset('assets/images/prologo.jpg')); ?>" alt="user-image" width="42" class="rounded-circle">
                    </span>
...
<?php /**PATH /home/realerp/public_html/probox/resources/views/components/user_topbar.blade.php ENDPATH**/ ?>