                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane show active" id="input-types-preview">
                                <div class="row">
                                    <form id="voucherForm" action="<?php echo e(route('shipper_purchases.update', $voucher->first()->v_no ?? 'N/A')); ?>"
                                        method="POST">
                                        <?php echo csrf_field(); ?>
                                                        ...
                                                        <?php if($voucher->isNotEmpty()): ?>
                                                            <?php $__currentLoopData = $voucher; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trndtl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo e($trndtl->shipperpurchases->items->item_code  ?? 'N/A'); ?></td>
                                                                    <td><?php echo e($trndtl->shipperpurchases->qty ?? 'N/A'); ?></td>
                                                                    <td><?php echo e($trndtl->shipperpurchases->rate ?? 'N/A'); ?></td>
                                                                    <td><?php echo e($trndtl->shipperpurchases->amount  ?? 'N/A'); ?></td>
                                                                    <td><?php echo e($trndtl->shipperpurchases->freight  ?? 'N/A'); ?></td>
                                                                    <td>
                                                                        <!-- Delete Entry Button -->
                                                                        <a href="<?php echo e(route('shipper_purchases.destroy', $trndtl->id)); ?>"
                                                                            class="btn btn-danger btn-sm"
                                                                            onclick="event.preventDefault();
                                                                            if(confirm('Are you sure you want to delete this transaction?')) {
                                                                                window.location.href='<?php echo e(route('shipper_purchases.destroy', $trndtl->id)); ?>';
                                                                            }">Delete</a>
                                                                    </td>
                                                                </tr>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/purchase_reports/edit9.blade.php ENDPATH**/ ?>