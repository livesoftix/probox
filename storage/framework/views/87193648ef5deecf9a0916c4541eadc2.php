    ...
    <div class="row heading-bg" style="display:flex; align-items:center; padding:10px 15px; margin-bottom:10px;">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"
            ...
            <ol class="breadcrumb" style="margin:0; padding:0; background:none; font-size:12px;">
                ...
                <li><a href="<?php echo e(route('stock-adj.index')); ?>">Stock Adjustment</a></li>
                ...
                <div >
                    <div >
                        <div class="form-wrap">
                            ...
                            <form action="<?php echo e(route('stock-adj.store')); ?>" method="POST">
                                <?php echo csrf_field(); ?>

                                
                                <input type="hidden" name="v_no" value="<?php echo e($nextVNo ?? ''); ?>">
                                <input type="hidden" name="prepared_by" value="<?php echo e($preparedByCid ?? ''); ?>">
                                <input type="hidden" name="cid" value="<?php echo e(auth()->user()->id); ?>">
                                ...
                                <div class="form-group mt-20 mb-0">
                                    ...
                                    <a href="<?php echo e(route('stock-adj.index')); ?>" class="btn btn-default btn-anim">
