      ...
      <div class="page-title-box">
        <div class="page-title-right">
          <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item active">Ink Return</li>
          </ol>
        </div>
        <h3 class="page-title">Ink Return</h3>
      </div>
    </div>
  </div>
  <!-- end page title -->
    ...
    <div class="card mt-2">
      <div class="card-body">
        ...
        <div class="tab-content">
          <div class="col-6">
            <form action="<?php echo e(route('ink_return.reports')); ?>" method="GET" class="form-inline" id="search-form">
              <div class="row">
                ...
                <div class="form-group mt-3">
                  ...
                  <a class="btn btn-success" href="<?php echo e(route('ink_return.list')); ?>" role="button"
                ...
                <table id="combined-data-table" class="table table-striped dt-responsive nowrap w-100">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo e($data->inkreturns->items->item_code ?? 'N/A'); ?></td>
                      <td><?php echo e($data->inkreturns->qty ?? 'N/A'); ?></td>
                      <td><?php echo e($data->inkreturns->rate ?? 'N/A'); ?></td>
                      <td><?php echo e($data->inkreturns->amount ?? 'N/A'); ?></td>
                      <td class="no-print">
                        ...
                        <td class="no-print">
            <?php if($data->inkreturns): ?> <!-- Check if plate return exists -->
            <form action="<?php echo e(route('ink_return.destroy', $data->inkreturns->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this record?');">
                <?php echo csrf_field(); ?>
...
<script>
  ...
  function printTable() {
   ...
   <?php
    ...
    $freightDetails = $trndtl->pluck('inkreturns')->filter(function ($detail) {
        return $detail->freight > 0;
    });

    // Calculate total quantities
    $totalQtys = $trndtl->pluck('inkreturns')->where('vorcher_no')->sum('qty');
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\probox\resources\views/ink_return/index.blade.php ENDPATH**/ ?>