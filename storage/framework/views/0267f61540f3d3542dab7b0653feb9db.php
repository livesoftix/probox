        ...
        <div class="card mt-2">
            <div class="card-body">
                <div class="tab-content">
                    <div class="col-6">
                        <form action="<?php echo e(route('dye_purchases.reports')); ?>" method="GET" class="form-inline"
                            id="search-form">
                            <div class="row">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <a class="btn btn-success" href="<?php echo e(route('dye_purchase.list')); ?>" role="button"
                                    ...
                                    <table id="combined-data-table"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($data->dyepurchases->items->item_code ?? 'N/A'); ?></td>
                                                <td><?php echo e($data->dyepurchases->qty ?? 'N/A'); ?></td>
                                                <td><?php echo e($data->description ?? 'N/A'); ?></td>
                                                <td><?php echo e($data->credit ?? 'N/A'); ?></td>
                                                <td><?php echo e($data->dyepurchases->freight ?? 'N/A'); ?></td>
                                                <td class="no-print">>
                                                    <?php if(!empty($data->dyepurchases->file_path)): ?>
                                                    <a href="<?php echo e(asset('storage/' . $data->dyepurchases->file_path)); ?>"
                                                        target="_blank">
                                                        <p>YES</p>
                                                    </a>
                                                    <?php else: ?>
                                                ...
                                                <td class="no-print">
                                                    <form
                                                        action="<?php echo e(route('dye_purchase.delete', ['id' => $data->id])); ?>"
                                                    ...
                                                    <a href="<?php echo e(route('dye_purchase.edit', ['v_no' => $data->v_no])); ?>"
                                                        class="btn btn-warning btn-sm"
                                                        onclick="return checkPermissionEdit()">Edit</a>
                                                        
                                                    <a href="<?php echo e(route('dye_purchase.editDye', ['v_no' => $data->v_no])); ?>" class="btn btn-primary btn-sm mt-1" >Freight</a>
                                                </td>
                                            </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/dye_purchase/index.blade.php ENDPATH**/ ?>