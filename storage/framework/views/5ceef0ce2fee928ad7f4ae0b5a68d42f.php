                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            ...
                            <li class="breadcrumb-item active">Dye Return</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Dye Return</h4>
                </div>
            </div>
        </div>
        <!-- End page title -->
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane show active" id="input-types-preview">
                                <div class="row">
                                    <form id="voucherForm" action="<?php echo e(route('dye_return.store')); ?>" method="POST" enctype="multipart/form-data">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="col-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="account" class="form-control select2" data-toggle="select2"
                                                    ...
                                                    <?php $__currentLoopData = $accounts->whereIn('level2_id', [4, 23]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accountSupplie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // File upload preview - Integrated from first script
    ...
    // Remove file - Integrated from first script
    ...
    addEntryButton.addEventListener('click', function() {
        ...
        if (entriesTable.children.length === 1) {
            ...
            document.getElementById('lockedSupplierId').value = supplierIdValue;
            document.getElementById('lockedSupplierTitle').value = supplierTitleValue;
        }
...
<?php echo $__env->make('layouts.condition', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\probox\resources\views/dye_return/list.blade.php ENDPATH**/ ?>