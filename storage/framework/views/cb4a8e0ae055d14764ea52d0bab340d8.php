        ...
        <div class="main-layout">
            <div class="left-col">
                ...
                <div class="specs-grid">
                        ...
                        <div class="spec-row" style="grid-column: 1 / -1;">
                            ...
                            <span class="spec-value bold-large" style="flex:1; display:block;">
                                <table class="ups-table">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $packagingSpec->details; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                    ...
                    <?php else: ?>
                        <div class="spec-row"><span class="spec-label">Printing Size</span>: <span
                                class="spec-value"><?php echo e($packagingSpec->printing_size ?? '—'); ?></span></div>
                        <div class="spec-row"><span class="spec-label">Board Size</span>: <span
                                class="spec-value"><?php echo e($packagingSpec->board_size ?? '—'); ?></span></div>
                        <div class="spec-row"><span class="spec-label">UPS</span>: <span
                                class="spec-value"><?php echo e($packagingSpec->ups ?? '—'); ?></span></div>
                    <?php endif; ?>
                    ...
                    <div class="spec-row" style="grid-column: 1;">
                        <span class="spec-label">Designing Color</span>: <span
                            class="spec-value"><?php echo e($packagingSpec->designing_color ?? '—'); ?></span>
                    </div>
                    <div class="spec-row" style="grid-column: 2;">
                        <span class="spec-label">Printing Side</span>: <span
                            class="spec-value"><?php echo e($packagingSpec->printing_side ?? '—'); ?></span>
                    </div>

                    <div class="spec-row" style="grid-column: 1;">
                        <span class="spec-label">Lamination Size</span>: <span
                            class="spec-value"><?php echo e($packagingSpec->lam_size); ?></span>
                    </div>
                    <div class="spec-row" style="grid-column: 2;">
                        <span class="spec-label">Length</span>: <span
                            class="spec-value size-small"><?php echo e($packagingSpec->length); ?></span> <span
                            class="unit"><?php echo e($packagingSpec->unit); ?></span>
                    </div>
                    <div class="spec-row" style="grid-column: 1;">
                        <span class="spec-label">Flute Size</span>: <span
                            class="spec-value"><?php echo e($packagingSpec->flute_size); ?></span>
                    </div>
                    <div class="spec-row" style="grid-column: 2;">
                        <span class="spec-label">Width</span>: <span
                            class="spec-value size-small"><?php echo e($packagingSpec->width); ?></span> <span
                            class="unit"><?php echo e($packagingSpec->unit); ?></span>
                    </div>
                    
                    <div class="spec-row" style="grid-column: 1;">
                        <span class="spec-label">Country</span>: <span
                            class="spec-value"><?php echo e($packagingSpec->country ?? '—'); ?></span>
                    </div>
                    <div class="spec-row" style="grid-column: 2;">
                        <span class="spec-label">Height</span>: <span
                            class="spec-value size-small"><?php echo e($packagingSpec->height); ?></span> <span
                            class="unit"><?php echo e($packagingSpec->unit); ?></span>
                    </div>
                </div>
                ...
                <div class="box-type-row">
                    ...
                    <span
                        class="spec-value size-medium"><?php echo e(optional($packagingSpec->boxType)->item_code ?? ($packagingSpec->box_type ?? 'N/A')); ?></span>
                </div>
                ...
                <div class="finishing-wrapper finishing-2x2">
                    <div class="finishing-col" style="grid-row:1;grid-column:1;">
                        ...
                        <label class="finishing-item">
                            <span class="checkbox-box<?php echo e($packagingSpec->emboss ? ' checkbox-checked' : ''); ?>"></span>
                            Emboss
                        </label>
                        <label class="finishing-item">
                            <span class="checkbox-box<?php echo e($packagingSpec->demboss ? ' checkbox-checked' : ''); ?>"></span>
                            Deboss
                        </label>
                        <label class="finishing-item">
                            <span
                                class="checkbox-box<?php echo e($packagingSpec->gold_finish ? ' checkbox-checked' : ''); ?>"></span>
                            Gold finish
                        </label>
                        <label class="finishing-item">
                            <span
                                class="checkbox-box<?php echo e($packagingSpec->silver_finish ? ' checkbox-checked' : ''); ?>"></span>
                            Silver finish
                        </label>
                    ...
                    <div class="finishing-col" style="grid-row:1;grid-column:2;">
                        ...
                        <label class="finishing-item">
                            <span class="checkbox-box<?php echo e($packagingSpec->uv_plain ? ' checkbox-checked' : ''); ?>"></span>
                            Plain
                        </label>
                        <label class="finishing-item">
                            <span class="checkbox-box<?php echo e($packagingSpec->uv_spot ? ' checkbox-checked' : ''); ?>"></span>
                            Spot
                        </label>
                        <label class="finishing-item">
                            <span class="checkbox-box<?php echo e($packagingSpec->uv_drip ? ' checkbox-checked' : ''); ?>"></span>
                            Drip
                        </label>
                    </div>
                    <div class="finishing-col" style="grid-row:2;grid-column:1;">
                        ...
                        <label class="finishing-item">
                            <span
                                class="checkbox-box<?php echo e($packagingSpec->window_lamination ? ' checkbox-checked' : ''); ?>"></span>
                            Lamination
                        </label>
                        <label class="finishing-item">
                            <span
                                class="checkbox-box<?php echo e($packagingSpec->window_glass ? ' checkbox-checked' : ''); ?>"></span>
                            Glass
                        </label>
                    </div>
                    <div class="finishing-col" style="grid-row:2;grid-column:2;">
                        ...
                        <label class="finishing-item">
                            <span
                                class="checkbox-box<?php echo e($packagingSpec->shine_lamination ? ' checkbox-checked' : ''); ?>"></span>
                            Shine
                        </label>
                        <label class="finishing-item">
                            <span
                                class="checkbox-box<?php echo e($packagingSpec->matte_lamination ? ' checkbox-checked' : ''); ?>"></span>
                            Matt
                        </label>
                ...
                <div class="box-details">
                    ...
                    <div class="box-detail-row">
                        <span class="spec-label">Glue Flap</span>: <span
                            class="spec-value"><?php echo e($packagingSpec->glue_flap); ?></span>
                    </div>
                    <div class="box-detail-row">
                        <span class="spec-label">Folding Flap</span>: <span
                            class="spec-value"><?php echo e($packagingSpec->holding_flap); ?></span>
                    </div>
                    <div class="box-detail-row">
                        <span class="spec-label">Pendi</span>: <span
                            class="spec-value"><?php echo e($packagingSpec->pendi); ?></span>
                    </div>
                    <div class="box-detail-row">
                        <span class="spec-label">Die Grip</span>: <span
                            class="spec-value"><?php echo e($packagingSpec->die_grip); ?></span>
                    </div>
                    <div class="box-detail-row">
                        <span class="spec-label">Die pattern</span>: <span
                            class="spec-value"><?php echo e($packagingSpec->die_pattern); ?></span>
                    </div>
                </div>
                ...
                <div class="diagram-section">
                    <?php if($packagingSpec->image_path): ?>
                        ...
                        <?php if(strtolower($ext) === 'pdf'): ?>
                            <embed src="<?php echo e(asset('storage/' . $packagingSpec->image_path)); ?>" type="application/pdf"
...
<?php /**PATH /home/realerp/public_html/probox/resources/views/packaging_specs/pdf.blade.php ENDPATH**/ ?>