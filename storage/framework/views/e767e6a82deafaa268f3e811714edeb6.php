            ...
            <div class="card">
                <div class="card-body">
                    <div class="tab-content">
                        <div class="col-12">
                            <form action="<?php echo e(route('daily_statement.reports')); ?>" method="GET"
                                ...
                                <div id="ledger">
                                    ...
                                    <div style="overflow-x: auto; width: 100%;">
                                        ...
                                        <div class="table-section no-printone">
                                            ...
                                            <div>
                                                <h5>
                                                    End Date: <span><?php echo e(request()->get('end_date') ?? date('d-m-Y')); ?></span>
                                                </h5>
                                            </div>
                                            <table id="customers-suppliers-table"
                                                ...
                                                <tbody>
                                                    <?php for($i = 0; $i < $maxCountSection1; $i++): ?>
                                                        <tr>
                                                            <!-- Customer Column 1 -->
                                                            ...
                                                            <td class="table-primary">
                                                                <?php echo e($filteredLevel7Accounts->values()->get($i * 2)->title ?? ''); ?>
                                                            ...
                                                            <td class="table-primary">
                                                                <?php echo e($filteredLevel7Accounts->values()->get($i * 2 + 1)->title ?? ''); ?>
                                                            ...
                                                            <td class="table-warning">
                                                                <?php echo e($filteredLevel4Accounts->values()->get($i * 2)->title ?? ''); ?>
                                                            ...
                                                            <td class="table-warning">
                                                                <?php echo e($filteredLevel4Accounts->values()->get($i * 2 + 1)->title ?? ''); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-primary" colspan="2">
                                                            <?php echo e(number_format($level7VisibleTotal, 2)); ?>

                                                        </td>
                                                        <td class="table-warning" colspan="2"><strong>G.Total:</strong>
                                                        </td>
                                                        <td class="table-warning" colspan="2">
                                                            <?php echo e(number_format($level4VisibleTotal, 2)); ?>
                                        ...
                                        <div class="table-section no-printsec">
                                            <table id="bank-cash-table"
                                                ...
                                                <tbody>
                                                    <?php for($i = 0; $i < $maxCountSection2; $i++): ?>
                                                        <tr>
                                                            <!-- Bank Column 1 -->
                                                            ...
                                                            <td class="table-danger">
                                                                <?php echo e($filteredLevel5Accounts->values()->get($i * 2)->title ?? ''); ?>
                                                            ...
                                                            <td class="table-danger">
                                                                <?php echo e($filteredLevel5Accounts->values()->get($i * 2 + 1)->title ?? ''); ?>
                                                            ...
                                                            <td class="table-info">
                                                                <?php echo e($filteredLevel6Accounts->values()->get($i)->title ?? ''); ?>
                                                            ...
                                                            <td class="table-success">
                                                                <?php echo e($filteredLevel14Accounts->values()->get($i)->title ?? ''); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="table-danger" colspan="2">
                                                            <?php echo e(number_format($level5VisibleTotal, 2)); ?>

                                                        </td>
                                                        <td class="table-info"><strong>G.Total:</strong>
                                                        </td>
                                                        <td class="table-info">
                                                            <?php echo e(number_format($level6VisibleTotal, 2)); ?>
                                                        ...
                                                        <td class="table-secondary">
                                                            <?php echo e(number_format($filteredPendingCheques->sum('chq_amt'), 2)); ?>

                                                        </td>
                                                        <td class="table-success"><strong>G.Total:</strong>
                                                        </td>
                                                        <td class="table-success">
                                                            <?php echo e(number_format($level14VisibleTotal, 2)); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/daily_statement/index.blade.php ENDPATH**/ ?>