...
<?php endif; ?>
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="input-types-preview">
                            <div class="row">
                        <form id="voucherForm" action="<?php echo e(route('delivery_challan.updateDel', $v_no)); ?>" method="POST">
    <?php echo csrf_field(); ?>
    ...
    <select name="freight_type" class="form-control select2" id="freight_type">
        ...
        <option value="Bilty" <?php echo e($freight_type == 'Bilty' ? 'selected' : ''); ?>>Bilty</option>
        <option value="Per Piece" <?php echo e($freight_type == 'Per Piece' ? 'selected' : ''); ?>>Per Piece</option>
    </select>
</div>
        ...
        <div class="mb-3" id="boxField" style="display: none;">
            ...
            <input type="number" id="box" class="form-control" name="box" value="<?php echo e($totalbox); ?>" readonly>
        </div>

        <!-- Freight Input Field (Initially Hidden) -->
        <div class="mb-3" id="freightField" style="display: none;">
    <label for="freight" class="form-label">Freight</label>
    <input type="number" id="freight" class="form-control" name="freight" value="<?php echo e($freight); ?>" step="any">
</div>
...
<script>
    ...
    const freightField = document.getElementById('freightField');
    const freightInput = document.getElementById('freight');
    const isAdmin = <?php echo e(auth()->user()->is_admin); ?>; // Fetch is_admin value from the logged-in user
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/sale_reports/editDelDc.blade.php ENDPATH**/ ?>