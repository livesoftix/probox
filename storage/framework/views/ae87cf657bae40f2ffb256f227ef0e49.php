                ...
                <div class="card-body">
                    <form id="voucherForm" action="<?php echo e(route('registration_form.update', $product->id)); ?>" method="POST"
                        ...
                        <div class="col-6">
                            ...
                            <div class="mb-3">
                                <label for="job_assign" class="form-label">Job Assigning</label>
                                <input type="text" id="job_assign" class="form-control" name="job_assign"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/registration_form/edit.blade.php ENDPATH**/ ?>