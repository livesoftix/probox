...
<?php endif; ?>
        ...
        <div class="card mt-2">
            <div class="card-body">
                <div class="tab-content">
                    <div class="col-6">
                        <form action="<?php echo e(route('payment_invoice.reports')); ?>" method="GET" class="form-inline" id="search-form">
                            <div class="row">
    ...
    <select name="account_id" class="form-control select2" data-toggle="select2">
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <a class="btn btn-success" href="<?php echo e(route('payment_invoice.list')); ?>" role="button" onclick="return checkPermission()">Add New</a>
                                </div>
    ...
    <tbody>
            ...
            <tr>
                ...
                <td><?php echo e($data->purchasedetails->items->item_code ?? 'N/A'); ?></td>
                <td><?php echo e($data->purchasedetails->width ?? 'N/A'); ?></td>
                <td><?php echo e($data->purchasedetails->lenght ?? 'N/A'); ?></td>
                <td><?php echo e($data->purchasedetails->grammage ?? 'N/A'); ?></td>
                <td><?php echo e($data->purchasedetails->qty ?? 'N/A'); ?></td>
                <td><?php echo e($data->purchasedetails->rate ?? 'N/A'); ?></td>
                <td><?php echo e($data->purchasedetails->total_wt ?? 'N/A'); ?></td>
                <td><?php echo e($data->purchasedetails->amount ?? 'N/A'); ?></td>
                <td class="no-print"><?php echo e($data->purchasedetails->freight?? 'N/A'); ?></td>
                <td class="no-print">
                    <input type="checkbox"
                ...
                <td class="no-print">
        <form action="<?php echo e(route('purchase_details.delete', ['id' => $data->id])); ?>" method="POST" style="display:inline;" class="delete-entry-form" data-entry-id="<?php echo e($data->id); ?>" onsubmit="return false;">
            <?php echo csrf_field(); ?>
            <?php echo method_field('DELETE'); ?>
            <span class="badge bg-danger" style="cursor:pointer;" onclick="confirmDeleteAjax(this, <?php echo e($data->id); ?>)">Delete</span>
        </form>
        <a href="<?php echo e(route('purchase_details.edit', ['v_no' => $data->v_no])); ?>" class="badge bg-warning text-dark mt-1" style="cursor:pointer;" onclick="return checkPermissionEdit()">Edit</a>
        <a href="<?php echo e(route('purchase_details.editBoxboard', ['v_no' => $data->v_no])); ?>" class="badge bg-primary mt-1" style="cursor:pointer;">Freight</a>
    </td>
            </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <tr>
...
<div style="display: flex; justify-content: flex-end; margin-top: 10px; font-size: 14px;">
    ...
    <?php $__currentLoopData = $freightDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php elseif($detail->freight_type == 'Per Piece'): ?>
            Per Piece <?php echo e($totalQtys); ?> * <?php echo e($totalQtys > 0 ? ($detail->freight / $totalQtys) : 0); ?> = <?php echo e($detail->freight); ?><br>
        <?php endif; ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</div>
<?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/purchase_reports/index.blade.php ENDPATH**/ ?>