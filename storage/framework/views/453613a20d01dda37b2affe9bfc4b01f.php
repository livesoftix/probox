...
<strong><?php echo e(number_format($boxboardData->sum('remain_qty'),2)); ?></strong>
...
action="<?php echo e(route('report.boxboard_stock')); ?>"
...
value="<?php echo e(request('item_id')); ?>">
...
class="suggestion-box list-group position-absolute w-100">
                        ...
                        <div class="col-xl-2">
                            ...
                            <input
                                ...
                                id="garmmage"
                                name="garmmage"
                                value="<?php echo e(request('garmmage')); ?>"
                                placeholder="GSM">
                        ...
                        <div class="col-xl-2">
                            ...
                            <input
                                ...
                                id="length"
                                name="length"
                                value="<?php echo e(request('length')); ?>"
                                placeholder="Length">
                        ...
                        <div class="col-xl-2">
                            ...
                            <input
                                ...
                                id="width"
                                name="width"
                                value="<?php echo e(request('width')); ?>"
                                placeholder="Width">
...
setupAutocomplete(
    '#item_name',
    '#item_suggestions',
    "<?php echo e(url('/probox/search-items')); ?>"
);
...
function printTable(){
    ...
    const totalItems=<?php echo e(count($boxboardData)); ?>;

    const totalQty="<?php echo e(number_format($boxboardData->sum('remain_qty'),2)); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\probox\resources\views/report_stock/index3.blade.php ENDPATH**/ ?>