                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="input-types-preview">
                            <div class="row">
                                <form id="voucherForm" action="<?php echo e(route('stock-adj.update', $voucher->first()->v_no)); ?>"
                                    method="POST">
                                    <?php echo csrf_field(); ?>
                                        ...
                                        <table class="table mt-4" id="entriesTable">
                                            ...
                                            <tbody id="entriesBody">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo e($trndtl->v_date ?? 'N/A'); ?>

                                                        <input type="hidden" name="date" value="<?php echo e($trndtl->v_date); ?>">
                                                    </td>
                                                    <!-- Show trndtl date -->
                                                    <td><?php echo e($trndtl->details->first()->accounts->title ?? 'N/A'); ?>

                                                        <input type="hidden" name="supplier" value="<?php echo e($trndtl->details->first()->accounts->title ?? 'N/A'); ?>">
                                                    </td>
                                                    <!-- Account title -->
                                                    <td><?php echo e($trndtl->details->first()->item_code); ?>

                                                        <input type="hidden" name="item" value="<?php echo e($trndtl->details->first()->item_code); ?>">
                                                    </td>
                                                    <td><?php echo e($trndtl->details->first()->width); ?>

                                                        <input type="hidden" name="width" value="<?php echo e($trndtl->details->first()->width); ?>">
                                                    </td>
                                                    <td><?php echo e($trndtl->details->first()->length); ?>

                                                        <input type="hidden" name="length" value="<?php echo e($trndtl->details->first()->length); ?>">
                                                    </td>
                                                    <td><?php echo e($trndtl->details->first()->grammage); ?>

                                                        <input type="hidden" name="gramage" value="<?php echo e($trndtl->details->first()->grammage); ?>">
                                                    </td>
                                                    <td><?php echo e($trndtl->details->first()->qty); ?>

                                                        <input type="hidden" name="quantity" value="<?php echo e($trndtl->details->first()->qty); ?>">
                                                    </td>
                                                    <td style="display:none;"><?php echo e($trndtl->details->first()->rate); ?>

                                                        <input type="hidden" name="rate" value="<?php echo e($trndtl->details->first()->rate); ?>">
                                                    </td>
                                                    <td style="display:none;"><?php echo e($trndtl->details->first()->total_wt); ?>

                                                        <input type="hidden" name="weight" value="<?php echo e($trndtl->details->first()->total_wt); ?>">
                                                    </td>
                                                    <td style="display:none;"><?php echo e($trndtl->details->first()->amount); ?>

                                                        <input type="hidden" name="amount" value="<?php echo e($trndtl->details->first()->amount); ?>">
                                                    </td>
                                                    <td style="display:none;"><?php echo e($trndtl->details->first()->freight); ?>

                                                        <input type="hidden" name="freight" value="<?php echo e($trndtl->details->first()->freight); ?>">
                                                    </td>
                                                    <td>
                                                        <!-- Delete Entry Button -->
                                                        <a href="<?php echo e(route('stock-adj.destroy', $trndtl->v_no)); ?>"
                                                            class="btn btn-danger btn-sm"
                                                            onclick="event.preventDefault();
                                                                            if(confirm('Are you sure you want to delete this transaction?')) {
                                                                                window.location.href='<?php echo e(route('stock-adj.destroy', $trndtl->v_no)); ?>';
                                                                            }">Delete</a>
                                                    </td>
                                                </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        addUpdateButton.addEventListener('click', function() {
            ...
            newRow.innerHTML = `
                ...
                <td>
                    ...
                    <input type="hidden" name="entries[${rowId}][width]" value="${width}">
                    <input type="hidden" name="entries[${rowId}][length]" value="${length}">
                    <input type="hidden" name="entries[${rowId}][gramage]" value="${gramage}">
                    ...
                    <input type="hidden" name="entries[${rowId}][weight]" value="${Math.round(weight)}">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\probox\resources\views/stock-adj/edit2.blade.php ENDPATH**/ ?>