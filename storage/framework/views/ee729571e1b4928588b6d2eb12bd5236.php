...
<?php endif; ?>
    ...
    <div class="row">
        ...
        <div class="col-6">
            <form action="<?php echo e(route('plate_purchase.reports')); ?>" method="GET" class="form-inline" id="search-form">
                <div class="row">
    ...
    <select name="account_id" class="form-control select2" data-toggle="select2">
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="form-group mt-3">
                                    ...
                                    <a class="btn btn-success" href="<?php echo e(route('plate_purchase.list')); ?>" role="button" onclick="return checkPermission()">Add New</a>
                                </div>
                </div>
            </form>
        </div>
            ...
            <table id="combined-data-table" class="table table-striped dt-responsive nowrap w-100">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($data->purchaseplates->items->item_code ?? 'N/A'); ?></td>
                        <td><?php echo e($data->purchaseplates->countries->country_name ?? 'N/A'); ?></td>
                        <td><?php echo e($data->purchaseplates->products->prod_name ?? 'N/A'); ?></td>
                        <td><?php echo e($data->purchaseplates->description); ?></td>
                        <td><?php echo e($data->purchaseplates->qty); ?></td>
                        <td><?php echo e($data->purchaseplates->rate); ?></td>
                        <td><?php echo e($data->purchaseplates->amount); ?></td>
                        <td class="no-print">
                            <input type="checkbox"
                        ...
                        <td class="no-print">
                            <div class="action-btns" style="display: flex; gap: 6px; align-items: center; justify-content: center;">
                                <form action="<?php echo e(route('plate_purchase.destroy', ['v_no' => $data->v_no, 'id' => $data->id])); ?>" method="POST" class="delete-entry-form" onsubmit="return false;" style="margin:0;">
                                    <?php echo csrf_field(); ?>
                                    <?php echo method_field('DELETE'); ?>
                                    <button type="button" class="action-icon-btn bg-danger" onclick="confirmDeleteAjaxIndex3(this, <?php echo e($data->id); ?>)" title="Delete">
                                        <i class="bi bi-trash3"></i>
                                    </button>
                                </form>
                                <a href="<?php echo e(route('plate_purchase.edit', ['v_no' => $data->v_no])); ?>" class="action-icon-btn bg-warning" onclick="return checkPermissionEdit()" title="Edit">
...
function printTable() {
    ...
    <?php if($freightValues->isNotEmpty()): ?>
        <div style="display: flex; justify-content: flex-end; margin-top: 10px; font-size: 14px;">
            <strong>Freight:</strong>
            <?php $__currentLoopData = $freightValues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $freight): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php echo e($freight); ?><br>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    <?php endif; ?>
`;
        ...
        <html>
            <head>
                ...
                <style>
                    ...
                    /* Only print tfoot on the last page */
                    @media print {
                        tfoot { display: table-footer-group; }
                        tfoot tr { page-break-inside: avoid; }
                        tfoot { visibility: hidden; }
                        tfoot:last-child { visibility: visible; }
                    }
...
function confirmDeleteAjaxIndex3(badge, entryId) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/purchase_reports/index3.blade.php ENDPATH**/ ?>