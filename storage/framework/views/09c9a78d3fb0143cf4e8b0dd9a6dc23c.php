        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">Lamination Return</h4>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <form id="voucherForm" action="<?php echo e(route('lamination_return.store')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="col-6">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        addEntryButton.addEventListener('click', function () {
            ...
            if (entriesTable.children.length === 1) {
                ...
                document.getElementById('lockedSupplierId').value = supplierValue;
                document.getElementById('lockedSupplierTitle').value = supplierText;
            }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\probox\resources\views/lamination_return/list.blade.php ENDPATH**/ ?>