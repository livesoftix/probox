            ...
            <div class="card shadow-sm" id="printable-area">
                <div class="card-body p-4">
                    ...
                    <div class="print-header">
                        ...
                        <small>Generated on: <?php echo e(now()->format('d M Y - H:i')); ?></small>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-8 detail-column">
                            ...
                            <table class="table table-borderless table-sm detail-table">
                                <tbody>
                                    <tr><th width="35%">Product Name</th><td class="fw-bold fs-5"><?php echo e($product->prod_name ?? 'N/A'); ?></td></tr>
                                    <tr><th>Party (Account)</th><td><?php echo e($product->account->title ?? 'N/A'); ?></td></tr>
                                    <tr><th>Product Type</th><td><?php echo e($product->product_type ?? 'N/A'); ?></td></tr>
                                    <tr><th>Job Assigning</th><td><?php echo e($product->job_assign ?? 'N/A'); ?></td></tr>
                                    <tr><th>Item Type</th><td><?php echo e($product->items->item_code ?? 'N/A'); ?></td></tr>
                                    <tr><th>Dimensions (H x W)</th><td><?php echo e($product->length ?? '-'); ?> x <?php echo e($product->width ?? '-'); ?></td></tr>
                                    <tr><th>Grammage</th><td><?php echo e($product->grammage ?? 'N/A'); ?></td></tr>
                                    <tr><th>Grain / Hard Side</th><td><?php echo e($product->grain_hard_side ?? 'N/A'); ?></td></tr>
                                    <tr><th>Ups</th><td><?php echo e($product->ups ?? 'N/A'); ?></td></tr>
                                    <tr><th>Country</th><td><?php echo e($product->country->country_name ?? 'N/A'); ?></td></tr>
                                    <tr><th>Product Rate</th><td><?php echo e($product->rate ?? '-'); ?></td></tr>
                                    <tr><th>Auto Pasting Rate (CTN)</th><td><?php echo e($product->auto_pasting_rate ?? '-'); ?></td></tr>
                                    <tr><th>Manual Pasting Rate (CTN)</th><td><?php echo e($product->manual_pasting_rate ?? '-'); ?></td></tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <table class="table table-borderless table-sm detail-table">
                        <tbody>
                            ...
                            <tr><th>Lamination</th><td>Type: <?php echo e($product->lamItem->item_code ?? 'N/A'); ?>, Size: <?php echo e($product->lam_size ?? 'N/A'); ?>, Impressions: <?php echo e($product->limpression ?? 'N/A'); ?></td></tr>
                            <?php endif; ?>
                            <?php if($product->uv): ?>
                            ...
                            <tr><th>Corrugation</th><td>Size: <?php echo e($product->curr_size ?? 'N/A'); ?>, Type: <?php echo e($product->currItem->item_code ?? 'N/A'); ?>, Labour: <?php echo e($product->clabour ?? 'N/A'); ?></td></tr>
                            <?php endif; ?>
                            <?php if($product->color): ?>
                            <tr><th>Color Printing</th><td>No. of Colors: <?php echo e($product->color_no); ?>, Design Colors: <?php echo e($product->design_color); ?></td></tr>
                            <?php endif; ?>
                            ...
                            <tr><th>Finishing:</th><td>
                                ...
                                <?php if($product->emboss): ?> | Emboss Rate: <?php echo e($product->emboss_rate); ?> <?php endif; ?>
                            </td></tr>
                            <?php endif; ?>
                    ...
                    <table class="table table-borderless table-sm detail-table mt-4">
                        <tr><th>Description:</th><td><?php echo e($product->descr); ?></td></tr>
                    </table>
                    <?php endif; ?>
                    ...
                    <div class="print-footer">
                        <div class="row">
                            <div class="col-6">
                                <small>Page 1 of 1 | Product ID: <?php echo e($product->id); ?></small>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\probox\resources\views/registration_form/print.blade.php ENDPATH**/ ?>