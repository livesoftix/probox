...
<div class="mb-3 position-relative">
    ...
    <input type="text"
           name="job_assign"
           class="form-control"
           value="<?php echo e($product->job_assign); ?>"
          >
         ...
         style="z-index: 9999; max-height: 250px; overflow-y: auto;"></div> -->
                            ...
                            <div id="breakingFields"
                             ...
                             <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox" id="auto_pasting" name="auto_pasting" value="1" <?php echo e($product->auto_pasting ? 'checked' : ''); ?>>
                                <label class="form-check-label" for="auto_pasting">Auto Pasting</label>
                            </div>
                            <div id="autopastingFields" style="<?php echo e($product->auto_pasting_rate ? 'display:block;' : 'display:none;'); ?>">                                                        
                            <div class="mb-3">
                            ...
                            <input type="number" id="auto_pasting_rate" class="form-control" name="auto_pasting_rate"
                             ...
                             <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox" id="manual_pasting" name="manual_pasting" value="1" <?php echo e($product->manual_pasting ? 'checked' : ''); ?>>
                                <label class="form-check-label" for="manual_pasting">Manual Pasting</label>
                            </div>  
                          <div id="manualpastingFields" style="<?php echo e($product->manual_pasting_rate ? 'display:block;' : 'display:none;'); ?>">        
                             <div class="mb-3">
...
<div class="mb-3">
    ...
    <select name="status" class="form-control select2" data-toggle="select2" id="status">
        <option value="active"
            <?php echo e(old('status', $product->status ?? 'active') == 'active' ? 'selected' : ''); ?>>
            Active
        </option>
        <option value="inactive"
            <?php echo e(old('status', $product->status ?? 'active') == 'inactive' ? 'selected' : ''); ?>>
            Inactive
        </option>
    </select>
</div>
