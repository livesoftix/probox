...
<div class="container-fluid">
        ...
        <div class="card mt-2">
            <div class="card-body">
                <div class="tab-content">
                    <div class="col-12">
                        <form action="<?php echo e(route('corrugation_wage_dc.report')); ?>" method="GET" class="form-inline" id="search-form">
     <div class="row">
    ...
    <div class="form-group mt-3">
        ...
        <a href="<?php echo e(route('corrugation_wage_dc.list')); ?>"
    ...
    <?php $__currentLoopData = $WageCorrugations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $general): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php
...
$contractor = \App\Models\TRNDTL::with('accounts')
    ...
    ->first();
        ...
        <tr>
            ...
            <td class="no-print">
            <a href="<?php echo e(route('corrugation_wage_dc.edit', $general->b_no)); ?>"
            class="btn btn-warning btn-sm">
            Edit
            </a>
            <a href="<?php echo e(route('corrugation_wage_dc.print', $general->b_no)); ?>"
            target="_blank"
            class="btn btn-primary btn-sm">
            Print
           </a>

                <form action="<?php echo e(route('corrugation_wage_dc.destroy', $general->id)); ?>" method="POST" style="display:inline-block;" onclick="return confirm('Are you sure you want to delete this transaction?')">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\probox\resources\views/wages/corrugation/index.blade.php ENDPATH**/ ?>