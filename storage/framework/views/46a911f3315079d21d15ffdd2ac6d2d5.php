...
<?php endif; ?>
    ...
    <div class="row">
        ...
        <div class="col-6">
            <form action="<?php echo e(route('purchase_return.reports')); ?>" method="GET" class="form-inline" id="search-form">
                <div class="row">
    ...
    <select name="account_id" class="form-control select2" data-toggle="select2">
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="form-group mt-3">
                                    ...
                                    <a class="btn btn-success" href="<?php echo e(route('purchase_return.list')); ?>" role="button" onclick="return checkPermission()">Add New</a>
                                </div>
                </div>
            </form>
        </div>
            ...
            <table id="combined-data-table" class="table table-striped dt-responsive nowrap w-100">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($data->purchasereturns->items->item_code ?? 'N/A'); ?></td>
                        <td><?php echo e($data->purchasereturns->width); ?></td>
                        <td><?php echo e($data->purchasereturns->lenght); ?></td>
                        <td><?php echo e($data->purchasereturns->grammage); ?></td>
                        <td><?php echo e($data->purchasereturns->total_wt); ?></td>
                        <td><?php echo e($data->purchasereturns->qty); ?></td>
                        <td><?php echo e($data->purchasereturns->rate); ?></td>
                        <td><?php echo e($data->purchasereturns->amount); ?></td>
                        <td class="no-print">
                                                <input type="checkbox"
                        ...
                        <td class="no-print">
                            <form action="<?php echo e(route('purchase_return.delete', ['id' => $data->id])); ?>" method="POST" style="display:inline;" onclick="return checkPermissionDel()">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/purchase_reports/index2.blade.php ENDPATH**/ ?>