...
<?php endif; ?>
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form id="voucherForm" action="<?php echo e(route('employees.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="col-6">
                         <div class="mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="bonus_id" id="bonus_id" class="form-control select2" data-toggle="select2">
                                    ...
                                    <option value="<?php echo e($extratime->id); ?>" <?php echo e(old('id')==$extratime->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/employees/list.blade.php ENDPATH**/ ?>