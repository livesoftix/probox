    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h3 class="page-title">Lamination Return</h3>
            </div>
        </div>
    </div>
    <!-- end page title -->
...
<?php endif; ?>
    ...
    <div class="row">
        ...
        <div class="col-6">
            <form action="<?php echo e(route('lamination_return.reports')); ?>" method="GET" class="form-inline" id="search-form">
                <div class="row">
    ...
    <select name="account_id" class="form-control select2" data-toggle="select2">
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="form-group mt-3">
                                    ...
                                    <a class="btn btn-success" href="<?php echo e(route('lamination_return.list')); ?>" role="button" onclick="return checkPermission()">Add New</a>
                                </div>
                </div>
            </form>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-12">
            ...
            <table id="combined-data-table" class="table table-striped dt-responsive nowrap w-100">
                ...
                <h4>Lamination Return Details</h4>
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($data->laminationreturns->item->item_code ?? 'N/A'); ?></td>
                        <td><?php echo e($data->laminationreturns->qty ?? 'N/A'); ?></td>
                        <td><?php echo e($data->laminationreturns->rate ?? 'N/A'); ?></td>
                        <td><?php echo e($data->laminationreturns->size ?? 'N/A'); ?></td>
                        <td><?php echo e($data->laminationreturns->amount ?? 'N/A'); ?></td>
                        <td class="no-print">
                                                <input type="checkbox"
                                              ...
                                              <td class="no-print">
            <?php if($data->laminationreturns): ?> <!-- Check if plate return exists -->
            <form action="<?php echo e(route('lamination_return.destroy', $data->laminationreturns->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this record?');">
                <?php echo csrf_field(); ?>
...
const freightContent = `
   <?php
    ...
    $freightDetails = $trndtl->pluck('laminationreturns')->filter(function ($detail) {
        return $detail->freight > 0;
    });

    // Calculate total quantities
    $totalQtys = $trndtl->pluck('laminationreturns')->where('vorcher_no')->sum('qty');
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\probox\resources\views/lamination_return/index.blade.php ENDPATH**/ ?>