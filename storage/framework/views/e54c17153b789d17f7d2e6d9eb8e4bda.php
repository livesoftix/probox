        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form id="voucherForm"
                          action="<?php echo e(route('autoPasting_wage_dc.store')); ?>"
                          method="POST">
...
$(document).ready(function () {
    ...
    $('#loadEntry').click(function () {
        ...
        const url = "<?php echo e(route('autoPasting_wage_dc.vouchers', [
            'type' => 'TYPE',
            'v_no' => 'V_NO'
        ])); ?>"
        .replace('TYPE', type)
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\probox\resources\views/wages/auto_pasting/list.blade.php ENDPATH**/ ?>