...
<?php endif; ?>
    ...
    <div class="row">
        ...
        <div class="col-6">
            <form action="<?php echo e(route('ink_purchase.reports')); ?>" method="GET" class="form-inline" id="search-form">
                <div class="row">
    ...
    <select name="account_id" class="form-control select2" data-toggle="select2">
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
               ...
               <div class="form-group mt-3">
                                    ...
                                    <a class="btn btn-success" href="<?php echo e(route('ink_purchase.list')); ?>" role="button" onclick="return checkPermission()">Add New</a>
                                </div>
                </div>
            </form>
        </div>
            ...
            <table id="combined-data-table" class="table table-striped dt-responsive nowrap w-100">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo e($data->inkpurchases->items->item_code ?? 'N/A'); ?></td>
                        <td><?php echo e($data->inkpurchases->qty ?? 'N/A'); ?></td>
                        <td><?php echo e($data->inkpurchases->rate ?? 'N/A'); ?></td>
                        <td><?php echo e($data->inkpurchases->amount ?? 'N/A'); ?></td>
                        <td class="no-print"><?php echo e($data->inkpurchases->freight ?? 'N/A'); ?></td>
                        <td class="no-print">
                            <input type="checkbox"
                        ...
                        <td class="no-print">
                            <form action="<?php echo e(route('ink_purchase.delete', ['id' => $data->id])); ?>" method="POST" style="display:inline;" onclick="return checkPermissionDel()">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                                <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete(this)">Delete</button>
                            </form>

                            <a href="<?php echo e(route('ink_purchase.edit', ['v_no' => $data->v_no])); ?>" class="btn btn-warning btn-sm" onclick="return checkPermissionEdit()">Edit</a>
                            <a href="<?php echo e(route('ink_purchase.editBoxboard', ['v_no' => $data->v_no])); ?>" class="btn btn-primary btn-sm mt-1">Freight</a>
                        </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/purchase_reports/index7.blade.php ENDPATH**/ ?>