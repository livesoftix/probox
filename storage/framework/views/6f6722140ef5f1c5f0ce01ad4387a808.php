      ...
      <div class="page-title-box">
        <div class="page-title-right">
          <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item active">Shipper Return</li>
          </ol>
        </div>
        <h3 class="page-title">Shipper Return</h3>
      </div>
    </div>
  </div>
  <!-- end page title -->
    ...
    <div class="card mt-2">
      <div class="card-body">
        ...
        <div class="tab-content">
          <div class="col-6">
            <form action="<?php echo e(route('shipper_return.reports')); ?>" method="GET" class="form-inline" id="search-form">
              <div class="row">
                ...
                <div class="form-group mt-3">
                  ...
                  <a class="btn btn-success" href="<?php echo e(route('shipper_return.list')); ?>" role="button"
                ...
                <table id="combined-data-table" class="table table-striped dt-responsive nowrap w-100">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo e($data->shipperreturns->items->item_code ?? 'N/A'); ?></td>
                      <td><?php echo e($data->shipperreturns->qty ?? 'N/A'); ?></td>
                      <td><?php echo e($data->shipperreturns->rate ?? 'N/A'); ?></td>
                      <td><?php echo e($data->shipperreturns->amount ?? 'N/A'); ?></td>
                      <td class="no-print">
                      ...
                      <td class="no-print">
                        <?php if($data->shipperreturns): ?> 
                        <form action="<?php echo e(route('shipper_return.destroy', $data->shipperreturns->id)); ?>" method="POST"
...
<script>
  ...
  function printTable() {
   ...
   <?php
    ...
    $freightDetails = $trndtl->pluck('shipperreturns')->filter(function ($detail) {
        return $detail->freight > 0;
    });

    // Calculate total quantities
    $totalQtys = $trndtl->pluck('shipperreturns')->where('vorcher_no')->sum('qty');
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\probox\resources\views/shipper_return/index.blade.php ENDPATH**/ ?>