...
<?php $__env->startSection('content'); ?>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane show active" id="input-types-preview">
                                <div class="row">
                                    <form id="voucherForm" action="<?php echo e(route('office_cash.update', $voucher->first()->v_no)); ?>"
    ...
    <select name="account_id" class="form-control select2" data-toggle="select2" id="account_id" >
        ...
        <?php $__currentLoopData = $accountMasters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($account->id); ?>" <?php echo e($account->id == $voucher[0]->cash_id ? 'selected' : ''); ?>>
        ...
        <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($account->id); ?>" <?php echo e($account->id == $voucher[0]->account_id ? 'selected' : ''); ?>>
                <?php echo e($account->title); ?>
                                                ...
                                                <tbody id="entriesBody">
                                                    ...
                                                    <?php $__currentLoopData = $voucher; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo e($entry->cashes->title ?? 'N/A'); ?></td> <!-- Adjust based on your relationships -->
                                                            <td><?php echo e($entry->accounts->title ?? 'N/A'); ?></td> <!-- Adjust based on your relationships -->
                                                            <td><?php echo e($entry->description); ?></td>
                                                            <td><?php echo e($entry->debit); ?></td> <!-- Change this to the correct amount field, e.g. debit or credit -->
                                                            <td>
                                                                <!-- Delete Entry Button -->
                                                                <a href="<?php echo e(route('office_cash.destroy', $entry->id)); ?>"
                                                                    class="btn btn-danger btn-sm"
                                                                    onclick="event.preventDefault();
                                                                    if(confirm('Are you sure you want to delete this transaction?')) {
                                                                        window.location.href='<?php echo e(route('office_cash.destroy', $entry->id)); ?>';
                                                                    }">Delete</a>
                                                            </td>
                                                        </tr>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/office_cash/edit.blade.php ENDPATH**/ ?>