    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h3 class="page-title">Plate Return</h3>
            </div>
        </div>
    </div>
    <!-- end page title -->
...
<?php endif; ?>
    ...
    <div class="row">
        ...
        <div class="col-6">
            <form action="<?php echo e(route('plate_return.reports')); ?>" method="GET" class="form-inline" id="search-form">
                <div class="row">
    ...
    <select name="account_id" class="form-control select2" data-toggle="select2">
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="form-group mt-3">
                                    ...
                                    <a class="btn btn-success" href="<?php echo e(route('plate_return.list')); ?>" role="button" onclick="return checkPermission()">Add New</a>
                                </div>
                </div>
            </form>
        </div>
    ...
    <tr>
        ...
        <td><?php echo e($data->platereturns->items->item_code ?? 'N/A'); ?></td>
        <td><?php echo e($data->platereturns->countries->country_name ?? 'N/A'); ?></td>
        <td><?php echo e($data->platereturns->products->prod_name ?? 'N/A'); ?></td>
        <td><?php echo e($data->platereturns->description ?? 'N/A'); ?></td>
        <td><?php echo e($data->platereturns->qty ?? 'N/A'); ?></td>
        <td><?php echo e($data->platereturns->rate ?? 'N/A'); ?></td>
        <td><?php echo e($data->platereturns->amount ?? 'N/A'); ?></td>
        <td class="no-print">
            <input type="checkbox"
        ...
        <td class="no-print">
            <?php if($data->platereturns): ?> <!-- Check if plate return exists -->
            <form action="<?php echo e(route('plate_return.destroy', $data->platereturns->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this record?');">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\probox\resources\views/plate_return/index.blade.php ENDPATH**/ ?>