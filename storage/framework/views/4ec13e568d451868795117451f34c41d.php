    ...
    <form action="<?php echo e(route('packaging-specs.update', $packagingSpec->id)); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="row mt-3 g-3">
            ...
            <div class="col-md-4">
                ...
                <input type="text" name="uv_size" class="form-control" value="<?php echo e(old('uv_size', $packagingSpec->uv_size)); ?>">
            </div>
        </div>
            ...
            <label class="form-check-label">
              ...
              <label class="form-check-label">
                ...
                <input type="checkbox" name="varnish" value="1" class="form-check-input me-1"
                    <?php echo e(old('varnish', $packagingSpec->varnish) ? 'checked' : ''); ?>> Varnish
            </label>
        </div>
    </div>
</div>
...
<script>
    ...
    // INIT
    setupAutocomplete('#company_name', "<?php echo e(url('/probox/search-company')); ?>");
    setupAutocomplete('#item_name', "<?php echo e(url('/probox/search-item')); ?>");
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\probox\resources\views/packaging_specs/edit.blade.php ENDPATH**/ ?>