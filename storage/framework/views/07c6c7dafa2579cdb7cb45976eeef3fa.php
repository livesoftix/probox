        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <form id="voucherForm" action="<?php echo e(route('lemination_purchase.store')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="col-6">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/lemination_purchase/list.blade.php ENDPATH**/ ?>