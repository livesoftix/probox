        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('open_bal.update', $voucher->first()->v_no)); ?>" method="POST" id="editVoucherForm">
                        <?php echo csrf_field(); ?>
                        <?php echo method_field('PUT'); ?>
                        <div class="mb-3">
                            <label for="entryDate" class="form-label">Opening Date</label>
                            <input type="date" id="entryDate" class="form-control" name="voucher_date" value="<?php echo e($voucher->first()->date ?? ''); ?>" required>
                        </div>
                        <table class="table table-bordered mt-4">
                            ...
                            <tbody id="entryTableBody">
                                <?php $__currentLoopData = $voucher; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($loop->iteration); ?>

                                        <input type="hidden" name="entry_id[<?php echo e($index); ?>]" value="<?php echo e($entry->id); ?>">
                                    </td>
                                    <td>
                                        <input type="date" name="entry_date[<?php echo e($index); ?>]" class="form-control" value="<?php echo e($entry->date); ?>" required>
                                    </td>
                                    <td>
                                        <select name="entry_account_title[<?php echo e($index); ?>]" class="form-control" required>
                                            <option value="">Select Account</option>
                                            <?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($account->id); ?>" <?php echo e($entry->account_id == $account->id ? 'selected' : ''); ?>>
                                    ...
                                    <td>
                                        <input type="number" name="entry_debit[<?php echo e($index); ?>]" class="form-control entry-debit" value="<?php echo e($entry->debit); ?>" min="0">
                                    </td>
                                    <td>
                                        <input type="number" name="entry_credit[<?php echo e($index); ?>]" class="form-control entry-credit" value="<?php echo e($entry->credit); ?>" min="0">
                                    </td>
                                    <td>
                                        <input type="text" name="description[<?php echo e($index); ?>]" class="form-control" value="<?php echo e($entry->description); ?>">
                                    </td>
                                    <td>
...
<script>
    ...
    function addEntryRow() {
        ...
        let accountOptions = `<?php $__currentLoopData = $accounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        row.innerHTML = `
            <td>${rowCount}</td>
            <td><input type="date" name="entry_date[]" class="form-control" value="<?php echo e(date('Y-m-d')); ?>" required></td>
            <td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/open_bal/edit.blade.php ENDPATH**/ ?>