        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Ink Purchase</h4>
                </div>
            </div>
        </div>
        <!-- End page title -->
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane show active" id="input-types-preview">
                                <div class="row">
                                    <form id="voucherForm" action="<?php echo e(route('ink_purchase.store')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <div class="col-6">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="account" class="form-control select2" data-toggle="select2"
                                                    ...
                                                    <?php $__currentLoopData = $accountSuppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $accountSupplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <option value="<?php echo e($accountSupplier->id); ?>">
        <?php echo e($accountSupplier->title); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/ink_purchase/list.blade.php ENDPATH**/ ?>