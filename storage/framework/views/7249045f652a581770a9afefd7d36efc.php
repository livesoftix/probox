...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <?php endif; ?>
            <div class="col-12">
                <a href="<?php echo e(route('level1.create')); ?>" onclick="return checkPermission()">
                                ...
                                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $level1s; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $level1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($level1->id); ?></td>
                                                <td><?php echo e($level1->title); ?></td>
                                                <td><?php echo e($level1->groups->title); ?></td>
                                                <td class="no-print">
                                                    <div class="d-flex">
                                                        <a href="<?php echo e(route('level1.edit', $level1->id)); ?>">
                                                            <button type="button" class="btn btn-primary"  onclick="return checkPermissionEdit()">Edit</button>
                                                        </a>
                                                        <form action="<?php echo e(route('level1.destroy', $level1->id)); ?>"
                                                            method="POST">
                                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/accounts/level1/list.blade.php ENDPATH**/ ?>