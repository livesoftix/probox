                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="input-types-preview">
                                <div class="row">
                                        ...
                                        <form id="voucherForm" action="<?php echo e(route('bank_payment.store')); ?>" method="POST" enctype="multipart/form-data">
                                            <div class="col-xl-6">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/bank_payment/list.blade.php ENDPATH**/ ?>