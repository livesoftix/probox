...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form id="voucherForm" action="<?php echo e(route('payment.update', $voucher->first()->v_no)); ?>"
                                ...
                                <tbody id="entriesBody">
                                    <?php $__currentLoopData = $voucher; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" name="entries[<?php echo e($entry->id); ?>][debit]" class="form-control" value="<?php echo e($entry->debit); ?>">
                                            </td>
                                            <td>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    addEntryButton.addEventListener('click', function () {
        ...
        newRow.innerHTML = `
            ...
            <td><input type="number" name="entries[${entryKey}][debit]" class="form-control" value="0"></td>
        ...
        row.querySelector('.remove-entry').addEventListener('click', function () {
            ...
            if (entryId) {
                if (confirm('Are you sure you want to delete this entry?')) {
                    fetch(`/probox/payment-delete/${entryId}`, {
                        method: 'DELETE',
                        headers: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/cash_reports/edit2.blade.php ENDPATH**/ ?>