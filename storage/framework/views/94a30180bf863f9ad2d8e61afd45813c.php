                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="input-types-preview">
                                <div class="row">
                                        ...
                                        <form id="voucherForm" action="<?php echo e(route('office_cash.store')); ?>" method="POST" enctype="multipart/form-data">
                                            <div class="col-xl-6">
                                                ...
                                                <select name="account" class="form-control select2" data-toggle="select2"
                                                    ...
                                                    <?php $__currentLoopData = $accountMasters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($account->id); ?>"
                                                            <?php echo e($account->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/office_cash/list.blade.php ENDPATH**/ ?>