...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <?php endif; ?>
            <div class="col-12">
                <a href="<?php echo e(route('print.list')); ?>"><button type="button" class="btn btn-primary" onclick="return checkPermission()">Add
                        Department</button></a>
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $printSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $print): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td class="no-print">
                                                    <form action="<?php echo e(route('print.destroy', $print->id)); ?>" method="POST" style="display: inline;" onclick="return confirm('Are you sure you want to delete this item?')">
            <?php echo csrf_field(); ?>
            <?php echo method_field('DELETE'); ?>
            <button type="submit" class="btn btn-danger" style="margin-left: 2px;"   onclick="return checkPermissionDel()" >Delete</button>
        </form>
        
         <a href="<?php echo e(route('print.edit', $print->id)); ?>" class="btn btn-warning  " onclick="return checkPermissionEdit()">Edit</a>
    ...
    function checkPermission() {
        ...
        if ($isAdmin == 0) {
            $userRights = \App\Models\Right::where('user_id', auth()->user()->id)
                ->where('app_name', 'departmentsetup')
                ->first();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/print/index.blade.php ENDPATH**/ ?>