                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="input-types-preview">
                            <div class="row">
                                <form id="voucherForm" action="<?php echo e(route('purchase_details.update', $voucher->first()->v_no)); ?>"
                                    method="POST">
                                    <?php echo csrf_field(); ?>
                                        ...
                                        <table class="table mt-4" id="entriesTable">
                                            ...
                                            <tbody id="entriesBody">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo e($trndtl->date ?? 'N/A'); ?>

                                                        <input type="hidden" name="date[]" value="<?php echo e($trndtl->date); ?>">
                                                    </td>
                                                    <!-- Show trndtl date -->
                                                    <td><?php echo e($trndtl->accounts->title ?? 'N/A'); ?>

                                                        <input type="hidden" name="supplier[]" value="<?php echo e($trndtl->accounts->title ?? 'N/A'); ?>">
                                                    </td>
                                                    <!-- Account title -->
                                                    <td><?php echo e($trndtl->purchasedetails->items->item_code); ?>

                                                        <input type="hidden" name="item[]" value="<?php echo e($trndtl->purchasedetails->items->item_code); ?>">
                                                    </td>
                                                    <td><?php echo e($trndtl->purchasedetails->width); ?>

                                                        <input type="hidden" name="width[]" value="<?php echo e($trndtl->purchasedetails->width); ?>">
                                                    </td>
                                                    <td><?php echo e($trndtl->purchasedetails->lenght); ?>

                                                        <input type="hidden" name="length[]" value="<?php echo e($trndtl->purchasedetails->lenght); ?>">
                                                    </td>
                                                    <td><?php echo e($trndtl->purchasedetails->grammage); ?>

                                                        <input type="hidden" name="gramage[]" value="<?php echo e($trndtl->purchasedetails->grammage); ?>">
                                                    </td>
                                                    <td><?php echo e($trndtl->purchasedetails->qty); ?>

                                                        <input type="hidden" name="quantity[]" value="<?php echo e($trndtl->purchasedetails->qty); ?>">
                                                    </td>
                                                    <td><?php echo e($trndtl->purchasedetails->rate); ?>

                                                        <input type="hidden" name="rate[]" value="<?php echo e($trndtl->purchasedetails->rate); ?>">
                                                    </td>
                                                    <td><?php echo e($trndtl->purchasedetails->total_wt); ?>

                                                        <input type="hidden" name="weight[]" value="<?php echo e($trndtl->purchasedetails->total_wt); ?>">
                                                    </td>
                                                    <td><?php echo e($trndtl->purchasedetails->amount); ?>

                                                        <input type="hidden" name="amount[]" value="<?php echo e($trndtl->purchasedetails->amount); ?>">
                                                    </td>
                                                    <td><?php echo e($trndtl->purchasedetails->freight); ?>

                                                        <input type="hidden" name="freight[]" value="<?php echo e($trndtl->purchasedetails->freight); ?>">
                                                    </td>
                                                    <td>
                                                        <!-- Delete Entry Button -->
                                                        <a href="<?php echo e(route('purchase_details.destroy', $trndtl->id)); ?>"
                                                            class="btn btn-danger btn-sm"
                                                            onclick="event.preventDefault();
                                                                            if(confirm('Are you sure you want to delete this transaction?')) {
                                                                                window.location.href='<?php echo e(route('purchase_details.destroy', $trndtl->id)); ?>';
                                                                            }">Delete</a>
                                                    </td>
                                                </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/purchase_reports/edit.blade.php ENDPATH**/ ?>