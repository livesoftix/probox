<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <?php endif; ?>
            <div class="col-12">
                <a href="<?php echo e(route('category.create')); ?>"><button type="button" class="btn btn-primary">Add
                        Category</button></a>
                                ...
                                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-print">
                                            ...
                                            <form action="<?php echo e(route('category.destroy', $category->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this category?');">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/category/list.blade.php ENDPATH**/ ?>