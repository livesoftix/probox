        ...
        <div class="card mt-2">
            <div class="card-body">
                <div class="tab-content">
                    <div class="col-12">
                        <form action="<?php echo e(route('bank_cash.reports')); ?>" method="GET" class="form-inline"
                            id="search-form">
                            <div class="row">
                                <!-- Start Date -->
                                ...
                                <div class="form-group col-xl-3">
                                    ...
                                    <select name="party_name" class="form-control select2" data-toggle="select2"
                                        ...
                                        <?php $__currentLoopData = $allParties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $party): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($party); ?>" <?php echo e(request('party_name')==$party ? 'selected' : ''); ?>>
                                            <?php echo e($party); ?>
                                ...
                                <div class="form-group col-xl-2">
                                    ...
                                    <select name="product_type" class="form-control select2" data-toggle="select2"
                                        ...
                                        <option value="Bank" <?php echo e(request('product_type')=='Bank' ? 'selected' : ''); ?>>
                                            Bank</option>
                                        <option value="Cash" <?php echo e(request('product_type')=='Cash' ? 'selected' : ''); ?>>
                                            Cash</option>
                                        <option value="JV" <?php echo e(request('product_type')=='JV' ? 'selected' : ''); ?>>
                                            JV</option>
                                        <option value="Che" <?php echo e(request('product_type')=='Chq' ? 'selected' : ''); ?>>
                                            Chq</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <a href="<?php echo e(route('bank_cash.reports')); ?>" class="btn btn-secondary">Reset</a>
                                </div>
                            </div>
                        </form>
                    </div>
                            ...
                            <div class="col-12">
                                ...
                                <table id="combined-data-table-bank"
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $grouped_bank; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th><?php echo e(number_format((float)$bank_total, 2, '.', ',')); ?></th>
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <table id="combined-data-table-cash"
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $grouped_cash; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($data['latest_date']); ?></td>
                                            <td><?php echo e($account); ?></td>
                                            <td><?php echo e(number_format((float)$data['total'], 2, '.', ',')); ?></td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <th colspan="2" style="text-align: right;">Grand Total:</th>
                                            <th><?php echo e(number_format((float)$cash_total, 2, '.', ',')); ?></th>
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <table id="combined-data-table-jv"
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $grouped_jv; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if((float)$data['total'] != 0.00): ?>
                                        <tr>
                                            <td><?php echo e($data['latest_date']); ?></td>
                                            <td><?php echo e($account); ?></td>
                                            <td><?php echo e(number_format((float)$data['total'], 2, '.', ',')); ?></td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <th colspan="2" style="text-align: right;">Grand Total:</th>
                                            <th><?php echo e(number_format((float)$jv_total, 2, '.', ',')); ?></th>
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <table id="combined-data-table-chq"
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $grouped_chq; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($data['latest_date']); ?></td>
                                            <td><?php echo e($account); ?></td>
                                            <td><?php echo e(number_format((float)$data['total'], 2, '.', ',')); ?></td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            <th colspan="2" style="text-align: right;">Grand Total:</th>
                                            <th><?php echo e(number_format((float)$chq_total, 2, '.', ',')); ?></th>
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <div style="margin-top: 20px; text-align: right;">
                                    <h4>Final Grand Total: <?php echo e(number_format((float)($bank_total + $cash_total +
                                        $jv_total + $chq_total ), 2, '.',
                                        ',')); ?></h4>
                                </div>

                                <?php elseif($productType == 'Bank'): ?>
                                <!-- Bank Details Table -->
                                <table id="combined-data-table-bank"
                                    class="table table-striped dt-responsive nowrap w-100">
                                    <h3>Bank Details</h3>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\probox\resources\views/bank_cash/index.blade.php ENDPATH**/ ?>