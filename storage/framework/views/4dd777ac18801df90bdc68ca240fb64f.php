<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <?php endif; ?>
            <div class="col-12">
                <a
                        href="<?php echo e(route('inventory.create.itemtype')); ?>"><button type="button" class="btn btn-primary" onclick="return checkPermission()" >Add Item</button></a>
                        <button type="button" class="btn btn-secondary" onclick="printTable()">Print Table</button> <!-- Print Button -->
                <div class="card mt-2">
                    <div class="card-body">
                        <h4 class="header-title">Item Types</h4>
                                ...
                                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $itemtypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $itemtype): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td><?php echo e($itemtype->id); ?></td>
                                                <td><?php echo e($itemtype->type_title); ?></td>
                                                <td class="no-print">
                                                    <div class="d-flex">
                                                    <a href="<?php echo e(route('inventory.itemtype.edit', $itemtype->id)); ?>">
                                                        <button type="button" class="btn btn-primary" onclick="return checkPermissionEdit()" >Edit</button>
                                                    </a>

                                                    
                                                    <form action="<?php echo e(route('inventory.itemtype.destroy', $itemtype->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this Item Type?');">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/inventory/list_item_type.blade.php ENDPATH**/ ?>