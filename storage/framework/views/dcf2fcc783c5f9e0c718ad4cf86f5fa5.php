...
<?php endif; ?>
    ...
    <div class="row">
        ...
        <div class="col-6">
            <form action="<?php echo e(route('shipper_purchases.reports')); ?>" method="GET" class="form-inline" id="search-form">
                <div class="row">
    ...
    <select name="account_id" class="form-control select2" data-toggle="select2">
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
               ...
               <div class="form-group mt-3">
                                    ...
                                    <a class="btn btn-success" href="<?php echo e(route('shipper_purchases.list')); ?>" role="button" onclick="return checkPermission()">Add New</a>
                                </div>
                </div>
            </form>
        </div>
                    ...
                    <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($data->shipperpurchases->items->item_code ?? 'N/A'); ?></td>
                                <td><?php echo e($data->shipperpurchases->qty ?? 'N/A'); ?></td>
                                <td><?php echo e($data->shipperpurchases->rate ?? 'N/A'); ?></td>
                                <td><?php echo e($data->shipperpurchases->amount ?? 'N/A'); ?></td>
                                <td class="no-print"><?php echo e($data->shipperpurchases->freight ?? 'N/A'); ?></td>
                                <td class="no-print">
                                    <input type="checkbox"
                                ...
                                <td class="no-print">
                                    <form action="<?php echo e(route('shipper_purchases.delete', ['id' => $data->id])); ?>" method="POST" style="display:inline;" onclick="return checkPermissionDel()">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                                        <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete(this)">Delete</button>
                                    </form>

                                    <a href="<?php echo e(route('shipper_purchases.edit', ['v_no' => $data->v_no])); ?>" class="btn btn-warning btn-sm " onclick="return checkPermissionEdit()">Edit</a>
                                    <a href="<?php echo e(route('shipper_purchases.editBoxboard', ['v_no' => $data->v_no])); ?>" class="btn btn-primary btn-sm mt-1">Freight</a>
                                </td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <tr>
...
function checkPermissionDel() {
    ...
    if (!<?php echo json_encode($canDelete, 15, 512) ?>) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/purchase_reports/index9.blade.php ENDPATH**/ ?>