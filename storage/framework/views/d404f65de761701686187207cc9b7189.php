...
<head>
    ...
    <title>
        Purchase Order - <?php echo e($purchaseOrder->po_code ?? 'PO'); ?>
...
<div class="page">
    ...
    <div class="company-header">
        ...
        <div class="document-title">
            ...
            <?php echo e($purchaseOrder->po_code ?? 'N/A'); ?>
    ...
    <table class="po-header">
        ...
        <tr>
            ...
            <td class="value">
                ...
                <?php if($purchaseOrder->po_date): ?>

                    <?php echo e(\Carbon\Carbon::parse($purchaseOrder->po_date)->format('d-m-Y')); ?>
        ...
        <tr>
            ...
            <td class="value">
                ...
                <?php if($purchaseOrder->delivery_date): ?>

                    <?php echo e(\Carbon\Carbon::parse($purchaseOrder->delivery_date)->format('d-m-Y')); ?>
    ...
    <table class="party-table">
        ...
        <tr>
            ...
            <td>
                ...
                <?php if(!empty($purchaseOrder->party_address)): ?>

                    <?php echo nl2br(e($purchaseOrder->party_address)); ?>
    ...
    <table class="additional-table">
        ...
        <tr>
            ...
            <td class="value">
                ...
                <?php if($purchaseOrder->preparedBy): ?>
        ...
        <tfoot>
            ...
            <tr class="total-row">
                ...
                <td class="quantity">
                    ...
                    <?php echo e(number_format((int) ($purchaseOrder->total_quantity ?? 0))); ?>
...
</html><?php /**PATH C:\laragon\www\probox\resources\views/purchase_orders/print.blade.php ENDPATH**/ ?>