            ...
            <div class="card mt-2">
                <div class="card-body">
                    <div class="tab-content">
                        <div class="col-12">
                            <form action="<?php echo e(route('pharma_billing.reports')); ?>" method="GET" class="form-inline"
                                id="search-form">
                                <div class="row">
                                    <!-- Start Date -->
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <a class="btn btn-success" href="<?php echo e(route('pharma_billing.list')); ?>" role="button"
                                ...
                                <div class="col-12">
                                            ...
                                            <?php $__currentLoopData = $trnDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php if(count($uniqueItemTitles) > 0): ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo e(strtoupper(substr($data1->accounts->title ?? 'N/A', 0, 1)) . strtoupper(substr(explode(' ', $data1->accounts->title ?? 'N/A')[1] ?? '', 0, 1))); ?>-<?php echo e($data1->v_no); ?>

                                                        </td>
                                                        <td><?php echo e($data1->accounts->title ?? 'N/A'); ?></td>
                                                        <td><?php echo e(implode(', ', $uniqueItemTitles)); ?></td>
                                                        <td><?php echo e(number_format($data1->debit ?? 'N/A')); ?></td>
                                                        <td>
                                                            <form
                                                                action="<?php echo e(route('pharma_billing.destroy', ['billing_no' => $data1->r_id])); ?>"
                                    ...
                                    <table id="combined-data-table-2"
                                        ...
                                        <h1 id="print-header" style="display: none;">
                                            <?php echo e($status == 'official' ? 'Prinitng Cell' : 'Rizwan Packages'); ?></h1>
                                        <?php
                                        ...
                                        <?php if($accountTitles): ?>
                                            <h1 id="print-header2" style="display: none;">Name: <?php echo e($accountTitles); ?></h1>
                                        <?php endif; ?>
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $filteredInvoices; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <?php if($index === $filteredInvoices->count() - 1 || $filteredInvoices[$index + 1]->v_no !== $data->v_no): ?>
                                                    <tr class="default-row">
                                                        <td colspan="6" style="text-align: right; font-weight: bold;">
                                                            Grand Total: </td>
                                                        <td colspan="2" style="font-weight: bold;">
                                                            <?php echo e(number_format($gtComputed, 2)); ?></td>
                                                    </tr>
                                                    <tr class="official-row" style="display: none;">
                                                        <td colspan="6" style="text-align: right; font-weight: bold;">
                                                            Total S.Tax Amount:</td>
                                                        <td style="font-weight: bold;">
                                                            <?php echo e(number_format($gtComputed, 2)); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/sale_reports/index6.blade.php ENDPATH**/ ?>