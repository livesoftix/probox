    ...
    <div class="card">
        <div class="card-body">
            <div class="tab-content">
                <div class="col-12">
                    <form action="<?php echo e(route('office_cash.reports')); ?>" method="GET" id="search-form">
                        <div class="row g-2 align-items-end">
                            ...
                            <div class="col-md-6 d-flex gap-2">
                                ...
                                <a class="btn btn-success" href="<?php echo e(route('office_cash.list')); ?>"
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $trndtls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trndtl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($trndtl->accounts->title); ?></td>
                                                    ...
                                                    <td class="no-print">
                                                        ...
                                                        <!-- Edit button -->
                                                        <a href="<?php echo e(route('office_cash.edit', $trndtl->v_no)); ?>"
                                                            class="btn btn-warning btn-sm"
                                                            onclick="return checkPermissionEdit()">Edit</a>

                                                        <!-- Delete button (use form for method spoofing) -->
                                                        <form action="<?php echo e(route('office_cash.delete', $trndtl->id)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/office_cash/index.blade.php ENDPATH**/ ?>