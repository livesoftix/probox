...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card mt-2">
                <div class="card-body">
                    <form action="<?php echo e(route('recieveables.list')); ?>" method="GET" class="form-inline" id="search-form">
                        <div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/recieveables/list.blade.php ENDPATH**/ ?>