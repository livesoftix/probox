...
<?php endif; ?>
    ...
    <form action="<?php echo e(route('plate_purchase.destroy', ['v_no' => $data->v_no, 'id' => $data->id])); ?>" 
          method="POST" 
        ...
        <button type="button"
                onclick="confirmDeleteAjaxIndex3(this, <?php echo e($data->id); ?>)"
                title="Delete"
                class="bg-danger"
            ...
            <i class="bi bi-trash3" style="font-size:14px;">Delete</i>
        </button>
    </form>

    <a href="<?php echo e(route('plate_purchase.edit', ['v_no' => $data->v_no])); ?>"
       ...
       style="width:56px; height:36px; display:flex; align-items:center; justify-content:center; border-radius:6px; color:#000; text-decoration:none; flex-shrink:0;">
        <i class="bi bi-pencil" style="font-size:14px; !text-white">Edit</i>
    </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\probox\resources\views/purchase_reports/index3.blade.php ENDPATH**/ ?>