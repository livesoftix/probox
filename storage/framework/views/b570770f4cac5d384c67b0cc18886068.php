            ...
            <div class="card mt-2">
                <div class="card-body">
                    <div class="tab-content">
                        <div class="col-12">
                            <form action="<?php echo e(route('confectionery.reports')); ?>" method="GET" class="form-inline"
                                id="search-form">
                                <div class="row">
                                    <!-- Start Date -->
                                    ...
                                    <div class="form-group mt-2">
                                        ...
                                        <a class="btn btn-success" href="<?php echo e(route('confectionery.list')); ?>" role="button"
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $trndtl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo e($data->ConfectioneryDetails->products->prod_name ?? 'N/A'); ?>

                                                        </td>

                                                        <td><?php echo e($data->confectioneryDetails->po_no ?? 'N/A'); ?></td>
                                                        <td><?php echo e($data->confectioneryDetails->box ?? 'N/A'); ?></td>
                                                        <td><?php echo e($data->confectioneryDetails->pack_qty ?? 'N/A'); ?></td>

                                                        <td><?php echo e($data->confectioneryDetails->total ?? 'N/A'); ?></td>
                                                        <td><?php echo e($data->confectioneryDetails->freight ?? 'N/A'); ?></td>
                                                        <td class="no-print" style="display:none;">
                                                            <?php echo e($data->confectioneryDetails->itemType->type_title ?? 'N/A'); ?>
                                                        ...
                                                        <td class="no-print">
                                                            <div
                                                                ...
                                                                <!-- Delete -->
                                                                <form
                                                                    action="<?php echo e(route('confectionery.delete', ['id' => $data->id])); ?>"
                                                                ...
                                                                <!-- Edit -->
                                                                <a href="<?php echo e(route('confectionery.edit', ['v_no' => $data->v_no])); ?>"
                                                                ...
                                                                <!-- Freight -->
                                                                <a href="<?php echo e(route('confectionery.editCon', ['v_no' => $data->v_no])); ?>"
                                                ...
                                                <div
                                                    ...
                                                    <div style="text-align: left;">
                                                        ...
                                                        <h3 style="margin: 2px 0 0 0; font-weight: bold;">Name:
                                                            <?php echo e($trndtl->unique('accounts.title')->pluck('accounts.title')->implode(', ')); ?>

                                                        </h3>
                                                    </div>
                                                    <div style="text-align: right;">
                                                        <h3 style="margin: 0; font-weight: bold;">Date:
                                                            <?php echo e($trndtl->unique('date')->pluck('date')->map(function ($date) {
                                                        ...
                                                        <h3 style="margin: 2px 0 0 0; font-weight: bold;">V.No:
                                                            <?php echo e($trndtl->unique('v_no')->pluck('v_no')->implode(', ')); ?>
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $trndtl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            <?php echo e($data->ConfectioneryDetails->products->prod_name ?? 'N/A'); ?>

                                                        </td>
                                                        <td colspan="2">
                                                            <?php echo e($data->confectioneryDetails->po_no ?? 'N/A'); ?></td>
                                                        <td colspan="2"><?php echo e($data->confectioneryDetails->box ?? 'N/A'); ?>

                                                        </td>
                                                        <td colspan="2">
                                                            <?php echo e($data->confectioneryDetails->pack_qty ?? 'N/A'); ?></td>
                                                        <td colspan="2">
                                                            <?php echo e($data->confectioneryDetails->freight ?? 'N/A'); ?></td>
                                                        <td colspan="2">
                                                            <?php echo e($data->confectioneryDetails->total ?? 'N/A'); ?></td>
                                                    </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
...
`);
    ...
    if (selectedHeading === 'Haider Packages GRW') {
        ...
        img.src = "<?php echo e(url('assets/images/proboxlogo.jpg')); ?>"; // IMPORTANT: absolute URL
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\probox\resources\views/sale_reports/index5.blade.php ENDPATH**/ ?>