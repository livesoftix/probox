...
<?php endif; ?>
            <div class="col-12">
                <a href="<?php echo e(route('level2.create')); ?>"><button type="button" class="btn btn-primary" onclick="return checkPermission()" >Add
                        Level2</button></a>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="basic-datatable-preview">
                                <table id="basic-datatable" class="table table-striped dt-responsive nowrap w-100">
                                    ...
                                    <tr>
                                        <td><?php echo e($level2->id); ?></td>
                                        <td><?php echo e($level2->title); ?></td>
                                        <td><?php echo e($level2->level1s->title); ?></td>
                                        <td class="no-print">
                                            <div class="d-flex">
                                                <a href="<?php echo e(route('level2.edit', $level2->id)); ?>">
                                                    <button type="button" class="btn btn-primary btn-sm" onclick="return checkPermissionEdit()">Edit</button>
                                                </a>

                                                <form action="<?php echo e(route('level2.destroy', $level2->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/accounts/level2/list.blade.php ENDPATH**/ ?>