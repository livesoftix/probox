            ...
            <div class="card mt-2">
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="col-6">
                            <form action="<?php echo e(route('corrugation_purchase.reports')); ?>" method="GET" class="form-inline"
                                id="search-form">
                                <div class="row">
    ...
    <select name="account_id" class="form-control select2" data-toggle="select2">
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <a class="btn btn-success" href="<?php echo e(route('corrugation_purchase.list')); ?>"
                                        ...
                                        <tbody>
                                            ...
                                            <?php $__currentLoopData = $trndtl; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo e($data->corrugationpurchases->item->item_code ?? 'N/A'); ?></td>
                                                    <td><?php echo e($data->corrugationpurchases->qty ?? 'N/A'); ?></td>
                                                    <td><?php echo e($data->corrugationpurchases->rate ?? 'N/A'); ?></td>
                                                    <td><?php echo e($data->corrugationpurchases->size ?? 'N/A'); ?></td>
                                                    <td><?php echo e($data->corrugationpurchases->amount ?? 'N/A'); ?></td>
                                                    <td class="no-print"><?php echo e($data->corrugationpurchases->freight ?? 'N/A'); ?></td>
                                                    <td class="no-print">
                                                    ...
                                                    <td class="no-print">
                                                        <form
                                                            action="<?php echo e(route('corrugation_purchase.delete', ['id' => $data->id])); ?>"
                                                        ...
                                                        <a href="<?php echo e(route('corrugation_purchase.edit', ['v_no' => $data->v_no])); ?>"
                                                            class="btn btn-warning btn-sm" onclick="return checkPermissionEdit()">Edit</a>
                                                            
                                                        <a href="<?php echo e(route('corrugation_purchase.editBoxboard', ['v_no' => $data->v_no])); ?>" class="btn btn-primary btn-sm mt-1" >Freight</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/purchase_reports/index6.blade.php ENDPATH**/ ?>