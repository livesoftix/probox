    ...
    <div class="card mt-2">
        <div class="card-body">
            <div class="tab-content">
                <div class="col-11">
                    <form action="<?php echo e(route('gate_pass_in.reports')); ?>" method="GET" class="form-inline" id="search-form">
                        <div class="row">
    ...
    <select name="account_id" class="form-control select2" data-toggle="select2">
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <a class="btn btn-success" href="<?php echo e(route('gate_pass_in.list')); ?>" role="button" onclick="return checkPermission()" >Add New</a>
                            </div>
...
<table id="combined-data-table" class="table table-striped dt-responsive nowrap w-100">
    ...
    <tbody>
        ...
        <?php $grandTotal += (float)($data->gatepassin->total ?? 0); ?>
        <tr>
            ...
            <td style="width: 250px; min-width: 250px; max-width: 250px; white-space: normal; word-wrap: break-word;">
                <?php echo e($data->description ?? 'N/A'); ?>

            </td>
            <td><?php echo e($data->gatepassin->qty ?? 'N/A'); ?></td>
            <td><?php echo e($data->gatepassin->rate ?? 'N/A'); ?></td>
            <td><?php echo e($data->gatepassin->total ?? 'N/A'); ?></td>
            <td>
                <?php if(!empty($data->gatepassin->file_path)): ?>
                <a href="<?php echo e(asset('storage/' . $data->gatepassin->file_path)); ?>" target="_blank">
                    <p>Img</p>
                </a>
                <?php else: ?>
                <p>No Img</p>
            ...
            <td class="no-print">
                <form action="<?php echo e(route('gate_pass_in.delete', ['id' => $data->id])); ?>" method="POST" style="display:inline;">
                    <?php echo csrf_field(); ?>
                    <?php echo method_field('DELETE'); ?>
                    <button type="button" class="btn btn-danger btn-sm" onclick="confirmDelete(this)">Delete</button>
                </form>
                <a href="<?php echo e(route('gate_pass_in.edit', ['v_no' => $data->v_no])); ?>" class="btn btn-warning btn-sm" onclick="return checkPermissionEdit()">Edit</a>
            </td>
        </tr>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </tbody>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/sale_reports/index3.blade.php ENDPATH**/ ?>