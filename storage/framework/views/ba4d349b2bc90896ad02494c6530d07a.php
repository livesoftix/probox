        ...
        <div class="col-12">
            <div class="card border-0 shadow-none">
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('journal_voucher.update', $voucher->first()->v_no)); ?>" method="POST" id="editVoucherForm">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" id="entryDate" class="form-control" name="voucher_date" 
                                   value="<?php echo e($voucher->first()->date ?? ''); ?>" required>
                        </div>
                        ...
                        <table class="table table-bordered mt-4">
                            ...
                            <tbody id="entryTableBody">
                                ...
                                <tr data-row-index="<?php echo e($index); ?>">
                                    <td class="row-number"><?php echo e($loop->iteration); ?></td>
                                    <td class="d-none">
                                        <input type="hidden" name="entries[<?php echo e($index); ?>][date]" class="entry-date" 
                                               value="<?php echo e($entry->date); ?>">
                                    </td>
                                    
                                    
                                    <td>
                                        <input type="hidden" name="entries[<?php echo e($index); ?>][id]" value="<?php echo e($entry->id); ?>">
                                        <select name="entries[<?php echo e($index); ?>][account_title]" class="form-control select2" data-toggle="select2" required>
                                    ...
                                    <td>
                                        <input type="number" name="entries[<?php echo e($index); ?>][debit]" 
                                               ...
                                               value="<?php echo e($entry->debit); ?>" min="0" step="0.01">
                                    </td>
                                    <td>
                                        <input type="number" name="entries[<?php echo e($index); ?>][credit]" 
                                               class="form-control entry-credit" 
                                               value="<?php echo e($entry->credit); ?>" min="0" step="0.01">
                                    </td>
                                    <td>
                                        <input type="text" name="entries[<?php echo e($index); ?>][description]" 
                                               class="form-control" value="<?php echo e($entry->description); ?>">
                                    </td>
                                    <td>
                                        <button type="button" class="btn btn-danger btn-sm" 
                                                onclick="deleteRow(this, <?php echo e($entry->id); ?>)" onclick="return confirm('Are you sure you want to delete this transaction?')" >Delete</button>
                                    </td>
                                </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
...
<script>
    let rowCounter = <?php echo e(count($voucher)); ?>;
    ...
    function addEntryRow() {
        ...
        const voucherDate = document.getElementById('entryDate').value || '<?php echo e(date("Y-m-d")); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/journal_voucher_reports/edit.blade.php ENDPATH**/ ?>