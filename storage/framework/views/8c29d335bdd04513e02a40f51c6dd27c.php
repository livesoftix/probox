    ...
    <div class="row heading-bg" style="display:flex; align-items:center; padding:10px 15px; margin-bottom:10px;">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"
            ...
            <ol class="breadcrumb" style="margin:0; padding:0; background:none; font-size:12px;">
                ...
                <li class="active"><span class="txt-primary">Stock  s</span></li>
            </ol>
        </div>
    </div>
    <!-- end page title -->
        ...
        <div class="col-sm-12">
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Filter Stock  s</h6>
                    </div>
                        ...
                        <form action="<?php echo e(route('stock-adj.index')); ?>" method="GET" id="search-form">
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-15">
                                    ...
                                    <a href="<?php echo e(route('stock-adj.create')); ?>" class="btn btn-success">Add  </a>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\probox\resources\views/report_stock/index2.blade.php ENDPATH**/ ?>