                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane show active" id="input-types-preview">
                            <div class="row">
                                <form id="voucherForm" action="<?php echo e(route('gate_pass_out.update', $voucher->first()->v_no)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="account" class="form-control select2" id="entryParty" data-toggle="select2" required>
                                ...
                                <?php $__currentLoopData = $accountMasters->whereIn('level2_id', [4, 7,15, 23]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $account): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <table class="table" id="entriesTable">
                                ...
                                <tbody id="entriesBody">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo e($trndtl->gatepassout->qty ?? 'N/A'); ?>

                                            <input type="hidden" name="qty[]" value="<?php echo e($trndtl->gatepassout->qty); ?>">
                                        </td>
                                        <!-- Rate -->
                                        <td>
                                            <?php echo e($trndtl->gatepassout->rate ?? 'N/A'); ?>

                                            <input type="hidden" name="rate[]" value="<?php echo e($trndtl->gatepassout->rate); ?>">
                                        </td>
                                         <!-- Total -->
                                        <td>
                                            <?php echo e($trndtl->gatepassout->total ?? 'N/A'); ?>

                                            <input type="hidden" name="total[]" value="<?php echo e($trndtl->gatepassout->total); ?>">
                                        </td>
                                      <td>
    <?php if(isset($trndtl->gatepassout->file_path)): ?>
        <img src="<?php echo e(asset('storage/' . $trndtl->gatepassout->file_path)); ?>" alt="Gatepass Image" style="max-width: 100px; max-height: 100px;">
    <?php else: ?>
        N/A
    <?php endif; ?>
    <input type="hidden" name="file_path[]" value="<?php echo e($trndtl->gatepassout->file_path ?? ''); ?>">
</td>
                                        ...
                                        <td>
                                                        <!-- Delete Entry Button -->
                                                        <a href="<?php echo e(route('gate_pass_out.destroy', $trndtl->id)); ?>"
                                                            class="btn btn-danger btn-sm"
                                                            onclick="event.preventDefault();
                                                                            if(confirm('Are you sure you want to delete this transaction?')) {
                                                                                window.location.href='<?php echo e(route('gate_pass_out.destroy', $trndtl->id)); ?>';
                                                                            }">Delete</a>
                                                    </td>
                                    </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/realerp/public_html/probox/resources/views/sale_reports/edit4.blade.php ENDPATH**/ ?>